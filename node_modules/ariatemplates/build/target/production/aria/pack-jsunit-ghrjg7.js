...
//*******************
var e=require("../Aria");!function(){var t,i,r;e.$global.AppletCallback=function(){null!=t&&(t.call(i,r),t=null,i=null,r=null)},module.exports=e.classDefinition({$classpath:"aria.jsunit.AppletWorker",$singleton:!0,$constructor:function(){this._applet=null,this._appletName=null,this._isReady=!1,this.$logWarn("aria.jsunit.AppletWorker class is deprecated and will be removed soon from the framework")},$destructor:function(){},$prototype:{init:function(e){if(null==this._applet&&(this._appletName=0,this._applet=this._addApplet(e),this._isReady=!0,!this._applet))throw new Error(this._appletName+" applet was not found in the document")},_addApplet:function(t){var i=e.$frameworkWindow.document.getElementById(t),r="<APPLET name='myTestApplet' code='ScreenCaptureApplet.class' archive='ScreenCapture.jar' width='1000' height='100' MAYSCRIPT></APPLET>";return i.innerHTML=r,this._getApplet()},_getApplet:function(){return e.$frameworkWindow.document.applets[this._appletName]||null},sendInstruction:function(e){t=e.cb,i=e.scope,r=e.args,this._applet.setInstruction(e.instruction,"AppletCallback")},getResponse:function(){var e=this._applet.getResponse(),t=1,i="No response yet - Retry later";if(-1!=e.indexOf(";")){var r=e.split(";");t=r[0],r.length>1&&(i=r[1])}return{code:t,reason:i}},isReady:function(){return this._isReady}}})}();
//*******************
...
//*******************
var e=require("../Aria");module.exports=e.classDefinition({$classpath:"aria.jsunit.Robot",$singleton:!0,$statics:{ROBOT_UNAVAILABLE:"There is no usable implementation of the robot.",BUTTON1_MASK:16,BUTTON2_MASK:8,BUTTON3_MASK:4},$constructor:function(){this.robot=null},$prototype:{getRobotClasspath:function(){if(e.$frameworkWindow.top.phantomJSRobot)return"aria.jsunit.RobotPhantomJS";var t=e.$window.navigator;try{var i=t&&t.javaEnabled();if(i)return"aria.jsunit.RobotJavaApplet"}catch(r){return null}},isUsable:function(){return!!this.getRobotClasspath()},initRobot:function(t){if(this.robot)this.robot.initRobot(t);else{var i=this.getRobotClasspath();if(!i)return void this.$logError(this.ROBOT_UNAVAILABLE);e.load({classes:[i],oncomplete:{fn:this._robotLoaded,scope:this,args:{robotClasspath:i,cb:t}}})}},_robotLoaded:function(t){this.robot||(this.robot=e.getClassRef(t.robotClasspath).$interface("aria.jsunit.IRobot")),this.robot.initRobot(t.cb)}}});
//*******************
//LOGICAL-PATH:aria/jsunit/RobotJavaApplet.js
//*******************
var e=require("../Aria"),t=require("../utils/Dom"),i=require("../utils/AriaWindow"),r=require("../utils/StringCallback"),s=require("./IRobot"),a=require("../core/DownloadMgr"),n=require("../core/Timer");module.exports=e.classDefinition({$classpath:"aria.jsunit.RobotJavaApplet",$implements:[s],$singleton:!0,$constructor:function(){this._robotInitialized=!1,this._initStringCb=null,i.$on({unloadWindow:this._reset,scope:this})},$destructor:function(){this._reset(),i.$unregisterListeners(this)},$events:{appletInitialized:""},$statics:{KEYS:{VK_0:48,VK_1:49,VK_2:50,VK_3:51,VK_4:52,VK_5:53,VK_6:54,VK_7:55,VK_8:56,VK_9:57,VK_A:65,VK_ACCEPT:30,VK_ADD:107,VK_AGAIN:65481,VK_ALL_CANDIDATES:256,VK_ALPHANUMERIC:240,VK_ALT:18,VK_ALT_GRAPH:65406,VK_AMPERSAND:150,VK_ASTERISK:151,VK_AT:512,VK_B:66,VK_BACK_QUOTE:192,VK_BACK_SLASH:92,VK_BACK_SPACE:8,VK_BACKSPACE:8,VK_BEGIN:65368,VK_BRACELEFT:161,VK_BRACERIGHT:162,VK_C:67,VK_CANCEL:3,VK_CAPS_LOCK:20,VK_CIRCUMFLEX:514,VK_CLEAR:12,VK_CLOSE_BRACKET:93,VK_CODE_INPUT:258,VK_COLON:513,VK_COMMA:44,VK_COMPOSE:65312,VK_CONTEXT_MENU:525,VK_CONTROL:17,VK_CONVERT:28,VK_COPY:65485,VK_CUT:65489,VK_D:68,VK_DEAD_ABOVEDOT:134,VK_DEAD_ABOVERING:136,VK_DEAD_ACUTE:129,VK_DEAD_BREVE:133,VK_DEAD_CARON:138,VK_DEAD_CEDILLA:139,VK_DEAD_CIRCUMFLEX:130,VK_DEAD_DIAERESIS:135,VK_DEAD_DOUBLEACUTE:137,VK_DEAD_GRAVE:128,VK_DEAD_IOTA:141,VK_DEAD_MACRON:132,VK_DEAD_OGONEK:140,VK_DEAD_SEMIVOICED_SOUND:143,VK_DEAD_TILDE:131,VK_DEAD_VOICED_SOUND:142,VK_DECIMAL:110,VK_DELETE:127,VK_DIVIDE:111,VK_DOLLAR:515,VK_DOWN:40,VK_E:69,VK_END:35,VK_ENTER:10,VK_EQUALS:61,VK_ESCAPE:27,VK_EURO_SIGN:516,VK_EXCLAMATION_MARK:517,VK_F:70,VK_F1:112,VK_F10:121,VK_F11:122,VK_F12:123,VK_F13:61440,VK_F14:61441,VK_F15:61442,VK_F16:61443,VK_F17:61444,VK_F18:61445,VK_F19:61446,VK_F2:113,VK_F20:61447,VK_F21:61448,VK_F22:61449,VK_F23:61450,VK_F24:61451,VK_F3:114,VK_F4:115,VK_F5:116,VK_F6:117,VK_F7:118,VK_F8:119,VK_F9:120,VK_FINAL:24,VK_FIND:65488,VK_FULL_WIDTH:243,VK_G:71,VK_GREATER:160,VK_H:72,VK_HALF_WIDTH:244,VK_HELP:156,VK_HIRAGANA:242,VK_HOME:36,VK_I:73,VK_INPUT_METHOD_ON_OFF:263,VK_INSERT:155,VK_INVERTED_EXCLAMATION_MARK:518,VK_J:74,VK_JAPANESE_HIRAGANA:260,VK_JAPANESE_KATAKANA:259,VK_JAPANESE_ROMAN:261,VK_K:75,VK_KANA:21,VK_KANA_LOCK:262,VK_KANJI:25,VK_KATAKANA:241,VK_KP_DOWN:225,VK_KP_LEFT:226,VK_KP_RIGHT:227,VK_KP_UP:224,VK_L:76,VK_LEFT:37,VK_LEFT_PARENTHESIS:519,VK_LESS:153,VK_M:77,VK_META:157,VK_MINUS:45,VK_MODECHANGE:31,VK_MULTIPLY:106,VK_N:78,VK_NONCONVERT:29,VK_NUM_LOCK:144,VK_NUMBER_SIGN:520,VK_NUMPAD0:96,VK_NUMPAD1:97,VK_NUMPAD2:98,VK_NUMPAD3:99,VK_NUMPAD4:100,VK_NUMPAD5:101,VK_NUMPAD6:102,VK_NUMPAD7:103,VK_NUMPAD8:104,VK_NUMPAD9:105,VK_O:79,VK_OPEN_BRACKET:91,VK_P:80,VK_PAGE_DOWN:34,VK_PAGE_UP:33,VK_PASTE:65487,VK_PAUSE:19,VK_PERIOD:46,VK_PLUS:521,VK_PREVIOUS_CANDIDATE:257,VK_PRINTSCREEN:154,VK_PROPS:65482,VK_Q:81,VK_QUOTE:222,VK_QUOTEDBL:152,VK_R:82,VK_RIGHT:39,VK_RIGHT_PARENTHESIS:522,VK_ROMAN_CHARACTERS:245,VK_S:83,VK_SCROLL_LOCK:145,VK_SEMICOLON:59,VK_SEPARATOR:108,VK_SHIFT:16,VK_SLASH:47,VK_SPACE:32,VK_STOP:65480,VK_SUBTRACT:109,VK_T:84,VK_TAB:9,VK_U:85,VK_UNDEFINED:0,VK_UNDERSCORE:523,VK_UNDO:65483,VK_UP:38,VK_V:86,VK_W:87,VK_WINDOWS:524,VK_X:88,VK_Y:89,VK_Z:90},absoluteUrlRegExp:/^(https?:\/)?\//},$prototype:{isUsable:function(){var t=e.$window.navigator;try{var i=t&&t.javaEnabled();return!!i}catch(r){return!1}},initRobot:function(t){if(null==this.applet){var s=e.$window.document,n=a.resolveURL("aria/jsunit/robot-applet.jnlp"),o=s.getElementsByTagName("head")[0].getElementsByTagName("base");if(o&&o[0]&&!this.absoluteUrlRegExp.test(n)){var l=o[0].getAttribute("href").replace(/[^\/.]+\.[^\/.]+$/,"").replace(/\/$/,"")+"/";n=l+n}var c=s.createElement("applet"),h=s.createElement("param");h.setAttribute("name","jnlp_href"),h.setAttribute("value",n),c.appendChild(h);var u=s.createElement("param");u.setAttribute("name","separate_jvm"),u.setAttribute("value","true"),c.appendChild(u);var p=s.createElement("param");p.setAttribute("name","initCallback"),this._initStringCb||(this._initStringCb=r.createStringCallback({scope:this,fn:this._callCallback,args:this._raiseInitEvent,resIndex:-1})),p.setAttribute("value",this._initStringCb),c.appendChild(p),c.setAttribute("width","1"),c.setAttribute("height","1");var d=a.resolveURL("aria/jsunit/robot-applet.jar",!0);c.setAttribute("archive",d),c.setAttribute("code","com.amadeus.ui.aria.robotapplet.RobotApplet"),c.style.cssText="position:absolute;display:block;left:0px;top:0px;width:1px;height:1px;z-index:-1;",s.body.appendChild(c),this.applet=c,i.attachWindow()}t&&(this._robotInitialized?this.$callback(t):this.$onOnce({appletInitialized:t}))},_raiseInitEvent:function(){this._robotInitialized=!0,this._initStringCb=null,this.$raiseEvent("appletInitialized")},_reset:function(){var t=this.applet;if(null!=t){var r=e.$window;r.document.body.removeChild(t),this._robotInitialized?this._robotInitialized=!1:this.$unregisterListeners(),this.applet=null,i.detachWindow()}},_updateAppletPosition:function(e){var i=this.applet,r=t._getDocumentScroll();i.style.left=r.scrollLeft+"px",i.style.top=r.scrollTop+"px",this._callCallback(e)},absoluteMouseMove:function(e,t){this.applet.absoluteMouseMove(e.x,e.y),this._callCallback(t)},mouseMove:function(e,i){var r=t._getViewportSize();(e.x<0||e.y<0||e.x>r.width||e.y>r.height)&&this.$logWarn("MouseMove position outside of the viewport."),this._updateAppletPosition({fn:this._mouseMoveCb,args:{position:e,cb:i}})},_mouseMoveCb:function(e,t){var i=t.position;this.applet.mouseMove(i.x,i.y),this._callCallback(t.cb)},smoothMouseMove:function(e,i,r,s){var a=t._getViewportSize();(e.x<0||e.y<0||e.x>a.width||e.y>a.height||i.x<0||i.y<0||i.x>a.width||i.y>a.height)&&this.$logWarn("smoothMouseMove from or to position outside of the viewport."),this._updateAppletPosition({fn:this._smoothMouseMoveCb,args:{from:e,to:i,duration:r,cb:s}})},_smoothMouseMoveCb:function(e,t){var i=t.from,s=t.to;this.applet.smoothMouseMove(i.x,i.y,s.x,s.y,t.duration,r.createStringCallback({fn:this._callCallback,scope:this,args:t.cb,resIndex:-1}))},mousePress:function(e,t){this.applet.mousePress(e),this._callCallback(t)},mouseRelease:function(e,t){this.applet.mouseRelease(e),this._callCallback(t)},mouseWheel:function(e,t){this.applet.mouseWheel(e),this._callCallback(t)},keyPress:function(e,t){this.applet.keyPress(e),this._callCallback(t)},keyRelease:function(e,t){this.applet.keyRelease(e),this._callCallback(t)},screenCapture:function(e,i,r){var s=t._getViewportSize();return e.x<0||e.y<0||e.width<0||e.height<0||e.x+e.width>s.width||e.y+e.height>s.height?void this.$logError("Screen capture area outside of the viewport."):void this._updateAppletPosition({fn:this._screenCaptureCb,args:{geometry:e,imageName:i,cb:r}})},_screenCaptureCb:function(e,t){var i=t.geometry;this.applet.screenCapture(i.x,i.y,i.width,i.height,t.imageName),this.$callback(t.cb)},compareImages:function(e,t){return this.applet.compareImages(e,t)},loadImage:function(e,t){this.applet.loadImage(e,t)},saveImage:function(e,t){this.applet.saveImage(e,t)},_callCallback:function(e){n.addCallback({fn:this.$callback,scope:this,args:e,delay:50})},getWin32Api:function(){return this.applet.getWin32Api()}}});
//*******************
...
//*******************
var e=require("../Aria"),t=require("./ScreenCapture"),i=require("./TestCase");module.exports=e.classDefinition({$classpath:"aria.jsunit.UITestCase",$extends:i,$constructor:function(){this.$TestCase.constructor.call(this),this.screenCapture=t,this.$logWarn("aria.jsunit.UITestCase class is deprecated and will be removed soon from the framework")},$destructor:function(){this.$TestCase.$destructor.call(this),this.screenCapture=null},$prototype:{runUITest:function(e){var t=e.scope?e.scope:this,i=this.screenCapture.capture({useCaseName:e.testCaseName,conf:{x:e.x?e.x:0,y:e.y?e.y:0,width:e.width?e.width:800,height:e.height?e.width:200,threshold:0},oncomplete:e.oncomplete,scope:t});i||(i=null,e.oncomplete.call(t))},getUITestResult:function(){return this.screenCapture.getResponse()}}});
//*******************
