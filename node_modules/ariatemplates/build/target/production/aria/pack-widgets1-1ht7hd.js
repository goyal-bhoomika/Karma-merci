...
//*******************
var e=require("../Aria"),t=require("../DomEvent"),i=require("../utils/Event"),r=require("../utils/Array"),a=require("../utils/Dom");require("../utils/Math");var s=require("../templates/NavigationManager"),n=require("../utils/AriaWindow"),o=require("../core/Browser"),l=require("../core/Timer");!function(){var c=null,u=null,h=null;module.exports=e.classDefinition({$classpath:"aria.popups.PopupManager",$events:{modalPopupPresent:"",modalPopupAbsent:"",popupOpen:"",popupClose:""},$onload:function(){c=r,u=a,h=i},$onunload:function(){c=null,u=null,h=null},$singleton:!0,$constructor:function(){this.openedPopups=[],this.modalPopups=0,this.popups=[],this.baseZIndex=2e4,this.currentZIndex=this.baseZIndex,n.$on({unloadWindow:this._reset,scope:this})},$destructor:function(){n.$unregisterListeners(this),this._reset()},$prototype:{_reset:function(){this._closeAllPopups(),this._unregisterAllPopups(),this.disconnectEvents()},_closeAllPopups:function(){for(var e=this.openedPopups.length-1;e>=0;e--){var t=this.openedPopups[e];t.close()}},_isEventInsidePopup:function(e,t){var i=a._getDocumentScroll(),r={top:e.clientY+i.scrollTop,left:e.clientX+i.scrollLeft},s={top:t.computedStyle.top,left:t.computedStyle.left},n={width:t.computedStyle.width,height:t.computedStyle.height};return r.top>=s.top&&r.left>=s.left&&r.top<=s.top+n.height&&r.left<=s.left+n.width},_unregisterAllPopups:function(){for(var e=this.popups.length-1;e>=0;e--){var t=this.popups[e];this.unregisterPopup(t)}},connectEvents:function(){this.disconnectEvents(),n.attachWindow(),this._document=e.$window.document,h.addListener(this._document,"mousedown",{fn:this.onDocumentClick,scope:this},!0),h.addListener(this._document,"touchend",{fn:this.onDocumentClick,scope:this},!0),h.addListener(this._document,"mouseout",{fn:this.onDocumentMouseOut,scope:this},!0),h.addListener(this._document,"mousewheel",{fn:this.onDocumentMouseScroll,scope:this},!0),o.isOldIE?i.addListener(e.$window,"mousewheel",{fn:this._onScroll,scope:this},!0):i.addListener(e.$window,"scroll",{fn:this._onScroll,scope:this},!0)},disconnectEvents:function(){this._document&&(h.removeListener(this._document,"mousedown",{fn:this.onDocumentClick}),h.removeListener(this._document,"touchend",{fn:this.onDocumentClick}),h.removeListener(this._document,"mouseout",{fn:this.onDocumentMouseOut}),h.removeListener(this._document,"mousewheel",{fn:this.onDocumentMouseScroll}),n.detachWindow(),this._document=null,o.isOldIE?i.removeListener(e.$window,"mousewheel",{fn:this._onScroll}):i.removeListener(e.$window,"scroll",{fn:this._onScroll}))},connectModalEvents:function(){var e=s;e.addGlobalKeyMap({key:"ESCAPE",modal:!0,callback:{fn:this._raiseOnEscapeEvent,scope:this}}),e.setModalBehaviour(!0),h.addListener(this._document.body,"focusin",{fn:this.onDocumentFocusIn,scope:this})},disconnectModalEvents:function(){var e=s;e.removeGlobalKeyMap({key:"ESCAPE",modal:!0,callback:{fn:this._raiseOnEscapeEvent,scope:this}}),e.setModalBehaviour(!1),h.removeListener(this._document.body,"focusin",{fn:this.onDocumentFocusIn})},_onScroll:function(e){for(var t=this.openedPopups.length-1;t>=0;t--){var i=this.openedPopups[t];"mousewheel"===e.type?l.addCallback({fn:i._isScrolling,scope:i}):"scroll"===e.type&&i._isScrolling()}},getZIndexForPopup:function(){return this.currentZIndex+=10,this.currentZIndex},hide:function(e){e.close(),e.$dispose()},onDocumentFocusIn:function(e){var i=new t(e),r=i.target,a=r!=this._document.body;if(a)for(var n=this.openedPopups.length-1;n>=0;n--){var o=this.openedPopups[n];if(u.isAncestor(r,o.getDomElement()))break;if(o.modalMaskDomElement){s.focusFirst(o.domElement);break}}i.$dispose()},onDocumentClick:function(e){var i=new t(e),r=i.target;if(0===this.openedPopups.length)return void i.$dispose();for(var a=this.openedPopups[this.openedPopups.length-1],s=!1,n=0,o=a._ignoreClicksOn.length;o>n;n++)if(u.isAncestor(r,a._ignoreClicksOn[n])){s=!0;break}s||u.isAncestor(r,a.getDomElement())||a.closeOnMouseClick(i),i.$dispose()},onDocumentMouseOut:function(e){for(var i=new t(e),r=i.target,a=i.relatedTarget,s=this.openedPopups.length-1;s>=0;s--){var n=this.openedPopups[s];!u.isAncestor(a,n.getDomElement())&&u.isAncestor(r,n.getDomElement())&&n.closeOnMouseOut(i)}i.$dispose()},onDocumentMouseScroll:function(e){for(var i=new t(e),r=i.target,a=this.openedPopups.length-1;a>=0;a--){var s=this.openedPopups[a];if(!u.isAncestor(r,s.getDomElement())){var n=s.closeOnMouseScroll(i);if(n)break}}i.$dispose()},onPopupOpen:function(e){c.isEmpty(this.openedPopups)&&this.connectEvents(),e.modalMaskDomElement&&(0===this.modalPopups&&(this.connectModalEvents(),this.$raiseEvent("modalPopupPresent")),this.modalPopups+=1),this.openedPopups.push(e),this.$raiseEvent({name:"popupOpen",popup:e})},onPopupClose:function(e){var t=this.openedPopups;c.remove(t,e),e.modalMaskDomElement&&(this.modalPopups-=1,0===this.modalPopups&&(this.disconnectModalEvents(),this.$raiseEvent("modalPopupAbsent"))),c.isEmpty(t)&&this.disconnectEvents(),this.$raiseEvent({name:"popupClose",popup:e});var i=t.length>0?t[t.length-1]:null;i&&s.focusFirst(i.domElement)},registerPopup:function(e){c.contains(this.popups,e)||this.popups.push(e)},show:function(e){var t=new aria.popups.Popup;return t.open(e),t},unregisterPopup:function(e){c.contains(this.openedPopups,e)&&c.remove(this.openedPopups,e),c.contains(this.popups,e)&&c.remove(this.popups,e),c.isEmpty(this.openedPopups)&&(this.currentZIndex=this.baseZIndex)},getPopupFromDom:function(e){for(var t=this.popups,i=0,r=t.length;r>i;i++){var a=t[i];if(a.domElement==e)return a}return null},_raiseOnEscapeEvent:function(){var e=this.openedPopups,t=e.length>0?e[e.length-1]:null;t&&t.modalMaskDomElement&&t.$raiseEvent("onEscape")}}})}();
//*******************
...
//*******************
Aria.classDefinition({$classpath:"aria.widgets.container.DivStyle",$extends:"aria.widgets.WidgetStyle",$extendsType:"CSS",$constructor:function(){this.$WidgetStyle.constructor.call(this)},$destructor:function(){this.$WidgetStyle.$destructor.call(this)},$prototype:{macro_main:function(){try{with(this)this.__$write("\n\n\n\n\n.xDIVtr {\nposition:relative;\nzoom:1;\n_overflow-y:hidden;\npadding:0px;\n}\n\n.xDIVtrc {\nposition:absolute;\ntop:0px;\nleft:0px;\nheight:100%;\n_height:1600px;\n}\n\n.xDIVbr {\nposition:relative;\nwidth:100%;\nfont-size:1px;\n}\n\n.xDIVbrc {\nposition:relative;\n}\n\n",10),this.macro_startLooping()}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["main",this["aria:currentLineNumber"]],_ex)}},__$initTemplate:function(){if(!this.$WidgetStyle.__$initTemplate.call(this))return!1;try{with(this)this.skinnableClassName="Div",this.useFrame=!0}catch(_ex){return this.$logError(this.EXCEPTION_IN_VARINIT,[this.$classpath],_ex),!1}return!0}}});
//*******************
...
//*******************
Aria.classDefinition({$classpath:"aria.widgets.action.LinkStyle",$extends:"aria.widgets.WidgetStyle",$extendsType:"CSS",$constructor:function(){this.$WidgetStyle.constructor.call(this)},$destructor:function(){this.$WidgetStyle.$destructor.call(this)},$prototype:{macro_writeState:function(info){try{with(this){var pseudoclass="";"normal"!=info.stateName&&(pseudoclass=":"+info.stateName),this.__$write("\n\na",12),this.__$write(pseudoclass,13),this.__$write(".xLink_",13),this.__$write(info.skinClassName,13),this.__$write(" {\ncolor:",13),this.__$write(info.state.color,14),this.__$write(";\n",14),info.state.textDecoration&&(this.__$write("\ntext-decoration:",16),this.__$write(info.state.textDecoration,16),this.__$write(";\n",16)),this.__$write("\n}\n",18)}}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["writeState",this["aria:currentLineNumber"]],_ex)}},__$initTemplate:function(){if(!this.$WidgetStyle.__$initTemplate.call(this))return!1;try{with(this)this.skinnableClassName="Link"}catch(_ex){return this.$logError(this.EXCEPTION_IN_VARINIT,[this.$classpath],_ex),!1}return!0}}});
//*******************
//LOGICAL-PATH:aria/widgets/action/Link.js
//*******************
var e=require("../../Aria"),t=require("../../utils/String"),i=require("./LinkStyle.tpl.css"),r=require("./ActionWidget");module.exports=e.classDefinition({$classpath:"aria.widgets.action.Link",$extends:r,$css:[i],$constructor:function(){this.$ActionWidget.constructor.apply(this,arguments),this._pressed=!1,this._customTabIndexProvided=!0,this._keyPressed=!1},$prototype:{_skinnableClass:"Link",_widgetMarkup:function(i){var r=this._cfg;i.write(["<a",e.testMode?' id="'+this._domId+'_link"':"",' class="xLink_',r.sclass,'" href="javascript:(function(){})()"',null!=r.tabIndex?" tabindex="+this._calculateTabIndex()+'"':"",">",t.escapeHTML(r.label),"</a>"].join("")),r=null},_init:function(){this._focusElt=this.getDom().firstChild,this.$ActionWidget._init.call(this)},_dom_onkeydown:function(e){return e.keyCode==aria.DomEvent.KC_ENTER?(this._keyPressed=!0,e.stopPropagation(),!1):!0},_dom_onclick:function(e){return e.preventDefault(),this._keyPressed?(this._keyPressed=!1,!1):this.$ActionWidget._dom_onclick.apply(this,arguments)},_dom_onkeyup:function(e){return e.keyCode==aria.DomEvent.KC_ENTER?this._performAction(e)?!0:(e.stopPropagation(),!1):!0}}});
//*******************
//LOGICAL-PATH:aria/widgets/Template.js
//*******************
var e=require("../Aria"),t=require("../templates/TemplateTrait"),i=require("../templates/TemplateCtxt"),r=require("../utils/Dom");require("../templates/CfgBeans"),require("../templates/ModuleCtrlFactory");var a=require("../core/environment/Customizations"),s=require("./container/Container"),n=require("../core/JsonValidator");module.exports=e.classDefinition({$classpath:"aria.widgets.Template",$extends:s,$events:{ElementReady:""},$constructor:function(e){aria.widgets.Template.superclass.constructor.apply(this,arguments),-1!=e.width&&(this._cssClassNames+=e.xForceScrollbar?" xOverflowXScroll":" xOverflowXAuto"),-1!=e.height&&(this._cssClassNames+=e.yForceScrollbar?" xOverflowYScroll":" xOverflowYAuto"),this._defaultMargin=0,this._subTplDiv=null,this.subTplCtxt=null,this._needCreatingModuleCtrl=e.moduleCtrl&&null==e.moduleCtrl.getData,this._tplcfg={classpath:a.getTemplateCP(e.defaultTemplate),args:e.args,id:this._domId,originalId:this.getId()},this.tplLoadCallback=null},$destructor:function(){this.removeDelegation(),this._subTplDiv=null,this.subTplCtxt&&(this.subTplCtxt.$dispose(),this.subTplCtxt=null),this.tplLoadCallback=null,this._deleteTplcfg(),aria.widgets.Template.superclass.$destructor.call(this)},$prototype:{$init:function(e){var i=t.prototype;for(var r in i)i.hasOwnProperty(r)&&!e.hasOwnProperty(r)&&(e[r]=i[r])},_directInit:!0,_deleteTplcfg:function(){if(this._tplcfg){var e=this._tplcfg,t=e.toDispose;if(t)for(var i=t.length,r=0;i>r;r++)t[r].$dispose();e.toDispose=null,e.tplDiv=null,e.div=null,e.data=null,this._tplcfg=null}},_errorWhileLoadingTemplate:function(){var e=this._subTplDiv;e&&(e.className="xTplContent",r.replaceHTML(e,"#ERROR WHILE LOADING TEMPLATE#")),this._deleteTplcfg(),this.$callback(this.tplLoadCallback,{success:!1})},_checkCfgConsistency:function(){var e=this._tplcfg,t=this._cfg;if(this._needCreatingModuleCtrl){if(!n.normalize({json:t.moduleCtrl,beanName:"aria.templates.CfgBeans.InitModuleCtrl"}))return void(this._cfgOk=!1)}else e.moduleCtrl=t.moduleCtrl;t.width>-1&&(e.width=t.width),t.height>-1&&(e.height=t.height),e.printOptions=t.printOptions,e.baseTabIndex=t.baseTabIndex},_onTplLoad:function(e,t){var r=this._tplcfg;if(!r)return void(t.autoDispose&&e.moduleCtrlPrivate.$dispose());var a=this._subTplDiv;r.tplDiv=a,r.div=this._domElt,r.data=this._cfg.data,e.moduleCtrl&&(r.moduleCtrl=e.moduleCtrl),r.isRootTemplate=!1,r.context=this._context,t.autoDispose&&(null==r.toDispose?r.toDispose=[e.moduleCtrlPrivate]:r.toDispose.push(e.moduleCtrlPrivate));var s=new i;this.subTplCtxt=s,s.parent=this._context;var e=s.initTemplate(r);e?(s.dataReady(),a&&s._cfg&&(a.className=s.getCSSClassNames(),s.$onOnce({Ready:this.__innerTplReadyCb,SectionRefreshed:{fn:this.__innerTpl1stRefreshed,args:{success:!0,templateCtxt:s},scope:this},scope:this}),s.$refresh()),this.tplcfg=null):(s.$dispose(),this.subTplCtxt=null,this._errorWhileLoadingTemplate()),a=null},__innerTpl1stRefreshed:function(e,t){this.$callback(this.tplLoadCallback,t)},_init:function(){aria.widgets.Template.superclass._init.call(this);var e=r.getDomElementChild(this._domElt,0);this._subTplDiv=e;var t=this.subTplCtxt;t&&(t.linkToPreviousMarkup(e),this.$callback(this.tplLoadCallback,{success:!0,templateCtxt:t}),t.viewReady()),this.isDiffered||(this.isDiffered=t&&!t._ready,this.isDiffered&&t.$on({Ready:{fn:this.__differedComplete,scope:this}}))},_widgetMarkup:function(t){var i=this._tplcfg;e.load({templates:[i.classpath],classes:this._needCreatingModuleCtrl?[this._cfg.moduleCtrl.classpath]:null,oncomplete:{scope:this,fn:this._onModuleCtrlLoad}});var r,a=this.subTplCtxt;a?(t.write('<div class="'+a.getCSSClassNames()+'">'),r=a.getMarkup(),t.write(null!=r?r:"#ERROR IN SUBTEMPLATE#"),t.write("</div>")):this._tplcfg?(t.write('<div class="xLDI"></div>'),this.isDiffered=!0):t.write("<div>#ERROR IN SUBTEMPLATE#</div>")},getDomElt:function(){return this._domElt},__differedComplete:function(){this.isDiffered=!1,this.$raiseEvent("ElementReady")}}});
//*******************
//LOGICAL-PATH:aria/widgets/calendar/ICalendarController.js
//*******************
var e=require("../../Aria"),t=require("../../templates/IModuleCtrl");module.exports=e.interfaceDefinition({$classpath:"aria.widgets.calendar.ICalendarController",$extends:t,$events:{focusChanged:"",update:"",dateClick:"",keyevent:""},$interface:{navigate:function(){},selectDay:function(){},update:function(){},keyevent:function(){},dateClick:function(){},getDatePosition:function(){},notifyFocusChanged:function(){}}});
//*******************
//LOGICAL-PATH:aria/widgets/calendar/CfgBeans.js
//*******************
var e=require("../../Aria"),t=require("../../core/JsonTypes"),i=require("../../core/environment/EnvironmentBaseCfgBeans");module.exports=e.beanDefinitions({$package:"aria.widgets.calendar.CfgBeans",$namespaces:{json:t,AppCfg:i},$beans:{CalendarSettings:{$type:"json:Object",$properties:{value:{$type:"json:Date"},minValue:{$type:"json:Date"},maxValue:{$type:"json:Date"},displayUnit:{$type:"json:Enum",$enumValues:["M","W"],$default:"M"},numberOfUnits:{$type:"json:Integer",$minValue:1,$default:2},startDate:{$type:"json:Date"},firstDayOfWeek:{$type:"json:Integer",$minValue:0,$maxValue:6},monthLabelFormat:{$type:"json:String",$default:"MMMM yyyy"},dayOfWeekLabelFormat:{$type:"json:String",$default:"EE"},dateLabelFormat:{$type:"json:String",$default:"d"},completeDateLabelFormat:{$type:"AppCfg:FormatTypes"},label:{$type:"json:String"},showWeekNumbers:{$type:"json:Boolean"},showShortcuts:{$type:"json:Boolean",$default:!0},restrainedNavigation:{$type:"json:Boolean",$default:!0},focus:{$type:"json:Boolean"}}},CalendarModel:{$type:"json:Object",$properties:{settings:{$type:"CalendarSettings"},skin:{$type:"json:Object",$properties:{sclass:{$type:"json:String"},baseCSS:{$type:"json:String"},skinObject:{$type:"json:ObjectRef"}}},calendar:{$type:"json:Object",$properties:{startDate:{$type:"json:Date",$mandatory:!0},endDate:{$type:"json:Date",$mandatory:!0},daysOfWeek:{$type:"json:Array",$contentType:{$type:"DayOfWeek"},$mandatory:!0},startWeekIndex:{$type:"json:Integer",$mandatory:!0},endWeekIndex:{$type:"json:Integer",$mandatory:!0},weeks:{$type:"json:Array",$contentType:{$type:"Week"},$mandatory:!0},startMonthIndex:{$type:"json:Integer",$mandatory:!0},endMonthIndex:{$type:"json:Integer",$mandatory:!0},months:{$type:"json:Map",$contentType:{$type:"Month"},$mandatory:!0},previousPageEnabled:{$type:"json:Boolean",$mandatory:!0},nextPageEnabled:{$type:"json:Boolean",$mandatory:!0},today:{$type:"json:Date",$mandatory:!0}}}}},DayOfWeek:{$type:"json:Object",$properties:{label:{$type:"json:String"},day:{$type:"json:Integer",$minValue:0,$maxValue:6}}},Month:{$type:"json:Object",$properties:{label:{$type:"json:String",$mandatory:!0},monthKey:{$type:"json:String",$mandatory:!0},firstOfMonth:{$type:"json:Date",$mandatory:!0},weeks:{$type:"json:Array",$contentType:{$type:"Week"},$mandatory:!0},weeksInMonth:{$type:"json:Integer",$minValue:4,$maxValue:6,$mandatory:!0},wholeWeeksInMonth:{$type:"json:Integer",$minValue:3,$maxValue:4,$mandatory:!0},daysBeforeStartOfMonth:{$type:"json:Integer",$minValue:0,$maxValue:6,$mandatory:!0},daysInMonth:{$type:"json:Integer",$minValue:28,$maxValue:31,$mandatory:!0},daysAfterEndOfMonth:{$type:"json:Integer",$minValue:0,$maxValue:6,$mandatory:!0}},$mandatory:!0},Week:{$type:"json:Object",$properties:{overlappingDays:{$type:"json:Integer",$mandatory:!0},monthStart:{$type:"json:String",$mandatory:!1},month:{$type:"json:String",$mandatory:!1},monthEnd:{$type:"json:String",$mandatory:!1},indexInMonth:{$type:"json:Integer",$mandatory:!0},weekNumber:{$type:"json:Integer",$mandatory:!0},days:{$type:"json:Array",$contentType:{$type:"Date"},$mandatory:!0}}},Date:{$type:"json:Object",$properties:{jsDate:{$type:"json:Date",$mandatory:!0},label:{$type:"json:String",$mandatory:!0},monthKey:{$type:"json:String",$mandatory:!0},isFirstOfMonth:{$type:"json:Boolean",$mandatory:!1},isLastOfMonth:{$type:"json:Boolean",$mandatory:!1},isSelected:{$type:"json:Boolean",$mandatory:!1},isWeekend:{$type:"json:Boolean",$mandatory:!1},isToday:{$type:"json:Boolean",$mandatory:!1},isSelectable:{$type:"json:Boolean",$mandatory:!1}},$mandatory:!0},DatePosition:{$type:"json:Object",$properties:{weekIndex:{$type:"json:Integer",$mandatory:!0},monthIndex:{$type:"json:Integer"},weekInMonthIndex:{$type:"json:Integer",$mandatory:!0},dayInWeekIndex:{$type:"json:Integer",$mandatory:!0},month:{$type:"Month",$mandatory:!0},week:{$type:"Week",$mandatory:!0},day:{$type:"Date",$mandatory:!0}}}}});
//*******************
//LOGICAL-PATH:aria/widgets/calendar/CalendarController.js
//*******************
var e=require("../../Aria"),t=require("./ICalendarController");require("../Template");var i=require("../../utils/Date");require("./CfgBeans");var r=require("../../utils/environment/Date"),a=require("../../utils/Array"),s=require("../../templates/ModuleCtrl"),n=require("../../core/JsonValidator");!function(){var o;module.exports=e.classDefinition({$classpath:"aria.widgets.calendar.CalendarController",$extends:s,$implements:[t],$onload:function(){o=i},$onunload:function(){o=null},$constructor:function(){this.$ModuleCtrl.constructor.call(this),this._dataBeanName="aria.widgets.calendar.CfgBeans.CalendarModel",this._changedSettings={value:{},minValue:{},maxValue:{},startDate:{},displayUnit:{},numberOfUnits:{},firstDayOfWeek:{},monthLabelFormat:{},dayOfWeekLabelFormat:{},dateLabelFormat:{},completeDateLabelFormat:{}},this._changedSettingsNbr=11},$destructor:function(){this._jsonListener&&(this.json.removeListener(this._calendarSettings,null,this._jsonListener),this._jsonListener=null),this._calendarData=null,this._calendarSettings=null,this.$ModuleCtrl.$destructor.call(this)},$prototype:{$hasFlowCtrl:!1,$publicInterfaceName:"aria.widgets.calendar.ICalendarController",_settingsProperties:{value:{isDate:!0},minValue:{isDate:!0},maxValue:{isDate:!0},startDate:{isDate:!0},displayUnit:{},numberOfUnits:{},firstDayOfWeek:{},monthLabelFormat:{},dayOfWeekLabelFormat:{},dateLabelFormat:{},completeDateLabelFormat:{}},_defaultKeyActions:{33:{increment:-1,incrementUnit:"M"},34:{increment:1,incrementUnit:"M"},35:{refDate:"maxValue"},36:{refDate:"minValue"},37:{increment:-1,incrementUnit:"D"},38:{increment:-7,incrementUnit:"D"},39:{increment:1,incrementUnit:"D"},40:{increment:7,incrementUnit:"D"}},_jsonDataChanged:function(e){var t=e.dataName,i=this._settingsProperties[t];if(i){var r=this._changedSettings[t];null==r&&(r={oldValue:e.oldValue,newValue:e.newValue},this._changedSettingsNbr++),(r.oldValue===e.newValue||i.isDate&&o.isSameDay(r.oldValue,e.newValue))&&(r=null,this._changedSettingsNbr--),this._changedSettings[t]=r}},init:function(e,t){e||(e={}),e.calendar={},e.settings||(e.settings={});var i=e.settings;this._data=e,this._calendarSettings=i,this._calendarData=e.calendar,i.startDate||(i.startDate=new Date),i.completeDateLabelFormat||(i.completeDateLabelFormat=r.getDateFormats().longFormat),null==i.firstDayOfWeek&&(i.firstDayOfWeek=r.getFirstDayOfWeek()),n.normalize({json:this._calendarSettings,beanName:"aria.widgets.calendar.CfgBeans.CalendarSettings"}),this.update(),this._jsonListener={fn:this._jsonDataChanged,scope:this},this.json.addListener(i,null,this._jsonListener,!0),this.$callback(t)},notifyFocusChanged:function(e){var t={name:"focusChanged",focus:e,cancelDefault:!1};return this.json.setValue(this._data.settings,"focus",e),this.$raiseEvent(t),t.cancelDefault},keyevent:function(e){var t={name:"keyevent",charCode:e.charCode,keyCode:e.keyCode,cancelDefault:!1},i=this._defaultKeyActions[t.keyCode];null!=i&&(t.cancelDefault=!0,this.json.inject(i,t,!1)),this.$raiseEvent(t);var r=this._transformDate(this._calendarSettings.value,t);return r&&this.selectDay({date:r}),t.cancelDefault===!0},getDatePosition:function(e){var t=a,i=this._calendarData,r=o.dayDifference(this._realStartDate,e),s=Math.floor(r/7);if(0>s||s>=i.weeks.length)return null;var n=i.weeks[s],l=r%7,c=n.days[l];this.$assert(228,o.isSameDay(e,c.jsDate));var u=null,h=null,p=i.months[c.monthKey];return null!=p&&(h=t.indexOf(i.months,p),this.$assert(239,p==i.months[h]),u=c.monthKey==n.month||c.monthKey==n.monthEnd?n.indexInMonth:0,this.$assert(245,p.weeks[u]==n)),{weekIndex:s,monthIndex:h,weekInMonthIndex:u,dayInWeekIndex:l,month:p,week:n,day:c}},dateClick:function(e){var t={name:"dateClick",date:e.date};this.$raiseEvent(t),this._data&&this.selectDay({date:t.date})},navigate:function(e,t){e&&e.preventDefault&&e.preventDefault();var i=this._calendarData.startDate,r=this._transformDate(i,t);null!=r&&(o.isSameDay(i,r)||o.isSameDay(this._calendarSettings.startDate,r)||(this.json.setValue(this._calendarSettings,"startDate",r),this.update()))},selectDay:function(e){var t=e.date;(!t||this._isSelectable(t))&&(this.json.setValue(this._calendarSettings,"value",t),this._ensureDateVisible(t),this.update())},_ensureDateVisible:function(e){if(e){var t=this._calendarData;(o.dayDifference(e,t.startDate)>0||o.dayDifference(e,t.endDate)<0||this._changedSettings.startDate)&&this.json.setValue(this._calendarSettings,"startDate",e)}},_getMonthKey:function(e){return[e.getMonth(),e.getFullYear()].join("-")},update:function(){if(0!==this._changedSettingsNbr){var e=this.json,t=this._changedSettings,i=this._calendarData,r=this._calendarSettings;if(t.minValue&&e.setValue(r,"minValue",o.removeTime(r.minValue)),t.maxValue&&e.setValue(r,"maxValue",o.removeTime(r.maxValue)),(t.value||t.minValue||t.maxValue)&&this._checkValue(),t.value&&1==this._changedSettingsNbr){var a=t.value,s=t.value.oldValue,n=r.value;if(s){var l=this.getDatePosition(s);l&&(l.day.isSelected=!1,a.oldValuePosition=l)}if(n){var c=this.getDatePosition(n);c&&(c.day.isSelected=!0,a.newValuePosition=c)}}else{(t.firstDayOfWeek||t.dayOfWeekLabelFormat)&&e.setValue(i,"daysOfWeek",this._createDaysOfWeek()),e.setValue(i,"today",new Date);var u,h,p,d=new Date(r.startDate);"W"==r.displayUnit?(d=o.getStartOfWeek(d,r.firstDayOfWeek),u=new Date(d.getFullYear(),d.getMonth(),1,12),u=o.getStartOfWeek(u,r.firstDayOfWeek),h=new Date(d.getTime()),h.setDate(h.getDate()+7*r.numberOfUnits-1),p=new Date(h.getTime()),p.setDate(32),p.setDate(1)):(d=new Date(d.getFullYear(),d.getMonth(),1,12),u=o.getStartOfWeek(d,r.firstDayOfWeek),h=new Date(d.getTime()),h.setMonth(h.getMonth()+r.numberOfUnits),h.setDate(h.getDate()-1),p=new Date(h.getTime()),p.setDate(p.getDate()+1));var m=[],g=[];this._createMonthsAndWeeks(u,p,m,g),e.setValue(i,"startDate",d),e.setValue(i,"endDate",h),e.setValue(i,"weeks",m),e.setValue(i,"months",g),e.setValue(i,"startMonthIndex",0),e.setValue(i,"endMonthIndex",g.length-1),e.setValue(i,"startWeekIndex",Math.floor(o.dayDifference(u,d)/7)),e.setValue(i,"endWeekIndex",Math.floor(o.dayDifference(u,h)/7)),this.$assert(128,i.endMonthIndex<g.length),this.$assert(129,i.endWeekIndex<m.length);var f=r.minValue,_=r.maxValue;e.setValue(i,"previousPageEnabled",!f||d>f),e.setValue(i,"nextPageEnabled",!_||_>h),this._realStartDate=u}var y=this._changedSettings,v=this._changedSettingsNbr;this._changedSettings={},this._changedSettingsNbr=0,this.$raiseEvent({name:"update",properties:y,propertiesNbr:v,propertyshowShortcuts:r.showShortcuts})}},_transformDate:function(e,t){var i;if(null!=t.increment)if(null==e&&(e=this._calendarSettings.startDate),i=new Date(e),"M"==t.incrementUnit){var r=i.getMonth();i.setMonth(r+t.increment),(24+r+t.increment)%12!=i.getMonth()&&i.setDate(0)}else i.setDate("D"==t.incrementUnit?i.getDate()+t.increment:i.getDate()+7*t.increment);else if(t.refDate){var a=t.refDate;"minValue"==a?this._calendarSettings.minValue&&(i=this._calendarSettings.minValue):"maxValue"==a&&this._calendarSettings.maxValue&&(i=this._calendarSettings.maxValue)}else t.date&&(i=new Date(t.date));return i},_createDaysOfWeek:function(){for(var e=[],t=this._calendarSettings.dayOfWeekLabelFormat,i=o.getStartOfWeek(new Date,this._calendarSettings.firstDayOfWeek),r=0;7>r;r++)e.push({label:o.format(i,t),day:i.getDay()}),i.setDate(i.getDate()+1);return e},_createMonthsAndWeeks:function(e,t,i,r){for(var a=new Date(e.getTime()),s=1==a.getDate()?a.getMonth():null;t>a;){var n=this._createWeek(a);if(i.push(n),a.getMonth()!=s){if(null!=s){var o=this._createMonth(i,i.length-1);r.push(o),r[o.monthKey]=o}s=a.getMonth()}}},_createWeek:function(e){for(var t,i=0,r=[],a={days:r,indexInMonth:1+Math.floor((e.getDate()-2)/7),weekNumber:o.dayOfWeekNbrSinceStartOfYear(e)},s=0;7>s;s++){var n=this._createDay(e);r.push(n),t?0===i&&t!=n.monthKey&&(i=s):t=n.monthKey,1==e.getDate()&&(a.monthStart=n.monthKey,n.isFirstOfMonth=!0),e.setDate(e.getDate()+1),1==e.getDate()&&(a.monthEnd=n.monthKey,n.isLastOfMonth=!0)}return a.overlappingDays=i,0===i&&(a.month=t),a},_isSelectable:function(e){var t=this._calendarSettings,i=t.minValue,r=t.maxValue;return(!i||e>=i)&&(!r||r>=e||o.isSameDay(e,r))},_checkValue:function(){var e=this._calendarSettings,t=e.value,i=e.minValue,r=e.maxValue,a=t;null!=t&&(i&&i>t&&(a=i),r&&t>r&&(a=r),a!=t&&(i>r&&(a=null),this.json.setValue(e,"value",a)))},_createDay:function(e){var t=this._calendarSettings,i=new Date(e.getFullYear(),e.getMonth(),e.getDate(),12),r=e.getDay(),a={jsDate:i,label:o.format(i,t.dateLabelFormat),monthKey:this._getMonthKey(e)};return(0===r||6===r)&&(a.isWeekend=!0),o.isSameDay(i,this._calendarData.today)&&(a.isToday=!0),o.isSameDay(i,t.value)&&(a.isSelected=!0),a.isSelectable=this._isSelectable(i),a},_createMonth:function(e,t){for(var i=e[t],r=i.days[0].monthKey,a=[],s={monthKey:r,weeks:a},n=t;n>=0;n--){var l=e[n];if(a.unshift(l),l.monthStart==r)break}var c=a[0];this.$assert(260,c.monthStart==r);var u=c.days[c.overlappingDays].jsDate;return s.firstOfMonth=u,s.label=o.format(u,this._calendarSettings.monthLabelFormat),s.weeksInMonth=a.length,s.daysBeforeStartOfMonth=c.overlappingDays,s.daysAfterEndOfMonth=i.overlappingDays>0?7-i.overlappingDays:0,s.daysInMonth=7*a.length-s.daysBeforeStartOfMonth-s.daysAfterEndOfMonth,s.wholeWeeksInMonth=a.length-(c.overlappingDays>0?1:0)-(i.overlappingDays>0?1:0),s}}})}();
//*******************
//LOGICAL-PATH:aria/widgets/calendar/CalendarStyle.tpl.css
//*******************
Aria.classDefinition({$classpath:"aria.widgets.calendar.CalendarStyle",$extends:"aria.widgets.WidgetStyle",$extendsType:"CSS",$constructor:function(){this.$WidgetStyle.constructor.call(this)},$destructor:function(){this.$WidgetStyle.$destructor.call(this)},$prototype:{macro_writeSkinClass:function(info){try{with(this){var skinClassName=info.skinClassName,skinClass=info.skinClass,general=aria.widgets.AriaSkinInterface.getGeneral();this.__$write("\n.xCalendar_",12),this.__$write(skinClassName,12),this.__$write("_general {\n",12),skinClass.generalBackgroundColor&&(this.__$write("\nbackground-color:",14),this.__$write(skinClass.generalBackgroundColor,14),this.__$write(";\n",14)),this.__$write("\n}\n.xCalendar_",16),this.__$write(skinClassName,17),this.__$write("_label {\nfont-weight:bold;\nmargin: 2px;\n}\n.xCalendar_",17),this.__$write(skinClassName,21),this.__$write("_general a:hover {\ntext-decoration: underline;\n}\ntable.xCalendar_",21),this.__$write(skinClassName,24),this.__$write("_month {\nfont-size:",24),this.__$write(skinClass.fontSize,25),this.__$write("px;\ntext-align: center;\nborder: 0px none;\nborder-collapse:separate;\nborder-spacing:0;\n}\n.xCalendar_",25),this.__$write(skinClassName,31),this.__$write("_monthTitle {\nwidth: 100%;\nborder-color:",31),this.__$write(skinClass.monthTitleBorderColor,33),this.__$write(";\nborder-style:solid;\nborder-width:1px 0;\ncolor:",33),this.__$write(skinClass.monthTitleColor,36),this.__$write(";\nfont-weight:bold;\nbackground-color:",36),this.__$write(skinClass.monthTitleBackgroundColor,38),this.__$write(";\npadding-top:",38),this.__$write(skinClass.monthTitlePaddingTop,39),this.__$write(";\npadding-bottom:",39),this.__$write(skinClass.monthTitlePaddingBottom,40),this.__$write(";\n",40),skinClass.monthTitleFontSize&&(this.__$write("\nfont-size:",42),this.__$write(skinClass.monthTitleFontSize,42),this.__$write("px;\n",42)),this.__$write("\n}\n.xCalendar_",44),this.__$write(skinClassName,45),this.__$write("_day {\n",45),skinClass.dayBorderColor&&(this.__$write("\nborder:1px solid ",47),this.__$write(skinClass.dayBorderColor,47),this.__$write(";\n",47)),this.__$write("\nwidth: 13px;\nbackground-color:",49),this.__$write(skinClass.dayBackgroundColor,50),this.__$write(";\ncolor:",50),this.__$write(skinClass.dayColor,51),this.__$write(";\npadding:",51),this.__$write(skinClass.dayPadding,52),this.__$write(";\nfont-weight:",52),this.__$write(skinClass.dayFontWeight,53),this.__$write(";\n}\n.xCalendar_",53),this.__$write(skinClassName,55),this.__$write("_weekEnd {\nbackground-color:",55),this.__$write(skinClass.weekEndBackgroundColor,56),this.__$write(";\nborder:1px solid ",56),this.__$write(skinClass.weekEndBorderColor,57),this.__$write(";\ncolor:",57),this.__$write(skinClass.weekEndColor,58),this.__$write(";\n}\n.xCalendar_",58),this.__$write(skinClassName,60),this.__$write("_selectable  {\ncursor: pointer;\n}\n.xCalendar_",60),this.__$write(skinClassName,63),this.__$write("_unselectable {\nborder: 1px solid ",63),this.__$write(this.$modifier("default",[skinClass.unselectableBorderColor,skinClass.dayBorderColor]),64),this.__$write(";\nbackground-color:",64),this.__$write(this.$modifier("default",[skinClass.unselectableBackgroundColor,skinClass.dayBackgroundColor]),65),this.__$write(";\ncolor:",65),this.__$write(this.$modifier("default",[skinClass.unselectableColor,general.colors.disabled]),66),this.__$write(";\n}\n.xCalendar_",66),this.__$write(skinClassName,68),this.__$write("_today {\nborder: 1px solid ",68),this.__$write(skinClass.todayBorderColor,69),this.__$write(";\nbackground-color:",69),this.__$write(skinClass.todayBackgroundColor,70),this.__$write(";\ncolor:",70),this.__$write(skinClass.todayColor,71),this.__$write(";\n}\n.xCalendar_",71),this.__$write(skinClassName,73),this.__$write("_weekNumber {\nbackground-color:",73),this.__$write(skinClass.weekNumberBackgroundColor,74),this.__$write(";\nborder:1px solid ",74),this.__$write(skinClass.weekNumberBorderColor,75),this.__$write(";\nfont-weight:bold;\nwidth: 13px;\n}\n.xCalendar_",75),this.__$write(skinClassName,79),this.__$write("_weekDaysLabel {\nbackground-color:",79),this.__$write(skinClass.weekDaysLabelBackgroundColor,80),this.__$write(";\nborder:1px solid ",80),this.__$write(skinClass.weekDaysLabelBorderColor,81),this.__$write(";\nfont-weight:",81),this.__$write(skinClass.weekDaysLabelFontWeight,82),this.__$write(";\ncolor:",82),this.__$write(skinClass.weekDaysLabelColor,83),this.__$write(";\nwidth: 13px;\npadding:",83),this.__$write(skinClass.weekDaysLabelPadding,85),this.__$write(";\n}\n.xCalendar_",85),this.__$write(skinClassName,87),this.__$write("_selected {\nbackground-color:",87),this.__$write(skinClass.selectedBackgroundColor,88),this.__$write(";\nborder: 1px solid ",88),this.__$write(skinClass.selectedBorderColor,89),this.__$write(";\ncolor:",89),this.__$write(skinClass.selectedColor,90),this.__$write(";\n}\n.xCalendar_",90),this.__$write(skinClassName,92),this.__$write("_mouseOver {\nbackground-color:",92),this.__$write(skinClass.mouseOverBackgroundColor?skinClass.mouseOverBackgroundColor:skinClass.selectedBackgroundColor,93),this.__$write(";\nborder: 1px solid ",93),this.__$write(skinClass.mouseOverBorderColor?skinClass.mouseOverBorderColor:skinClass.selectedBorderColor,94),this.__$write(";\ncolor:",94),this.__$write(skinClass.mouseOverColor?skinClass.mouseOverColor:skinClass.selectedColor,95),this.__$write(";\n}\n",95)}}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["writeSkinClass",this["aria:currentLineNumber"]],_ex)}},__$initTemplate:function(){if(!this.$WidgetStyle.__$initTemplate.call(this))return!1;try{with(this)this.skinnableClassName="Calendar"}catch(_ex){return this.$logError(this.EXCEPTION_IN_VARINIT,[this.$classpath],_ex),!1}return!0}}});
//*******************
//LOGICAL-PATH:aria/widgets/calendar/CalendarTemplate.tpl
//*******************
Aria.classDefinition({$classpath:"aria.widgets.calendar.CalendarTemplate",$extends:"aria.templates.Template",$constructor:function(){this.$Template.constructor.call(this),this.$CalendarTemplateScript.constructor.call(this)},$destructor:function(){this.$CalendarTemplateScript.$destructor.call(this),this.$Template.$destructor.call(this)},$dependencies:["aria.widgets.AriaLib","aria.widgets.calendar.CalendarTemplateScript","aria.widgets.container.Div","aria.utils.String","aria.utils.Type","aria.utils.Date","aria.widgets.Icon","aria.core.TplClassLoader"],$resources:{res:"aria.resources.CalendarRes"},$prototype:{macro_main:function(){try{with(this)"M"==settings.displayUnit&&this.__$beginContainerWidget("aria.widgets.AriaLib","Div",{sclass:skin.skinObject.divsclass,margins:"0 0 0 0",block:!0,cssClass:skin.baseCSS+"general"},16)&&(this.macro_renderCalendar(),this.__$endContainerWidget())}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["main",this["aria:currentLineNumber"]],_ex)}},macro_renderCalendar:function(){try{with(this){settings.label&&(this.__$write('\n<div class="',29),this.__$write(this.$modifier("escapeforhtml",[skin.baseCSS]),29),this.__$write('label">',29),this.__$write(this.$modifier("escapeforhtml",[settings.label]),29),this.__$write("</div>\n",29));for(var startIndex=calendar.startMonthIndex,endIndex=calendar.endMonthIndex,index=startIndex;endIndex>=index;index++)this.__$write('\n<span style="display: inline-block; vertical-align: top; margin: 2px;">\n',32),this.macro_renderMonth(calendar.months[index],index==startIndex,index==endIndex),this.__$write("\n</span>\n",34);settings.showShortcuts&&(this.__$write('\n<div style="text-align: center; margin: 1px;">\n<a title="',37),this.__$write(this.$modifier("escapeforhtml",[this.$modifier("dateformat",[calendar.today,settings.completeDateLabelFormat])]),38),this.__$write('" tabIndex="-1" href="javascript:;" ',38),this.__$statementOnEvent("click",this.$normCallback({fn:"navigate",scope:moduleCtrl,args:{date:calendar.today}}),38),this.__$write(">",38),this.__$write(this.$modifier("escapeforhtml",[res.today]),38),this.__$write("</a>\n",38),this.__$insertSection(39,{id:"selectedDay",macro:"selectedDay"}),this.__$write("\n</div>\n",43))}}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["renderCalendar",this["aria:currentLineNumber"]],_ex)}},macro_selectedDay:function(){try{with(this)settings.value&&(this.__$write('\n&nbsp;|&nbsp; <a title="',49),this.__$write(this.$modifier("escapeforhtml",[this.$modifier("dateformat",[settings.value,settings.completeDateLabelFormat])]),49),this.__$write('" tabIndex="-1" href="javascript:;" ',49),this.__$statementOnEvent("click",this.$normCallback({fn:"navigate",scope:moduleCtrl,args:{date:settings.value}}),49),this.__$write(">",49),this.__$write(this.$modifier("escapeforhtml",[res.selectedDate]),49),this.__$write("</a>\n",49))}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["selectedDay",this["aria:currentLineNumber"]],_ex)}},macro_renderMonth:function(month,first,last){try{with(this){this.__$write('\n<table class="',54),this.__$write(this.$modifier("escapeforhtml",[skin.baseCSS]),54),this.__$write('month" cellspacing="0" style="width: ',54),this.__$write(this.$modifier("escapeforhtml",[settings.showWeekNumbers?138:128]),54),this.__$write('px;">\n<thead>\n<tr>\n<th colspan="8">\n<div class="',54),this.__$write(this.$modifier("escapeforhtml",[skin.baseCSS]),58),this.__$write('monthTitle" style="position: relative;">\n',58),!first||!calendar.previousPageEnabled&&settings.restrainedNavigation||(this.__$write('\n<div style="position: absolute; left: 0px; top: -2px; cursor: pointer;" ',60),this.__$statementOnEvent("click",this.$normCallback({fn:"navigate",args:{increment:-1,incrementUnit:"M"},scope:moduleCtrl}),60),this.__$write(">",60),this.__$processWidgetMarkup("aria.widgets.AriaLib","Icon",{icon:skin.skinObject.previousPageIcon},60),this.__$write("</div>\n",60)),!last||!calendar.nextPageEnabled&&settings.restrainedNavigation||(this.__$write('\n<div style="position: absolute; right: 0px; top: -2px; cursor: pointer;" ',63),this.__$statementOnEvent("click",this.$normCallback({fn:"navigate",args:{increment:1,incrementUnit:"M"},scope:moduleCtrl}),63),this.__$write(">",63),this.__$processWidgetMarkup("aria.widgets.AriaLib","Icon",{icon:skin.skinObject.nextPageIcon},63),this.__$write("</div>\n",63)),this.__$write(this.$modifier("escapeforhtml",[month.label]),65),this.__$write("\n</div>\n</th>\n</tr>\n<tr>\n",66),settings.showWeekNumbers&&(this.__$write('<th  class="',70),this.__$write(this.$modifier("escapeforhtml",[skin.baseCSS]),70),this.__$write('weekNumber">&nbsp;</th>',70));var __v_1=calendar.daysOfWeek;void 0==calendar.daysOfWeek&&this.$logError(this.ITERABLE_UNDEFINED,["foreach",71]);for(var day_ct=0,__v_2=__v_1.length,day_index=0;__v_2>day_index;day_index++){var day=__v_1[day_index];day_ct++,this.__$write('\n<th class="',72),this.__$write(this.$modifier("escapeforhtml",[skin.baseCSS]),72),this.__$write('weekDaysLabel">',72),this.__$write(this.$modifier("escapeforhtml",[day.label]),72),this.__$write("</th>\n",72)}this.__$write("\n</tr>\n</thead>\n<tbody ",74),this.__$statementOnEvent("click",this.$normCallback(clickDay),76),this.__$write(" ",76),this.__$statementOnEvent("mouseover",this.$normCallback(mouseOverDay),76),this.__$write(" ",76),this.__$statementOnEvent("mouseout",this.$normCallback(mouseOutDay),76),this.__$write(" ",76),this.__$writeId("month_"+month.monthKey,76),this.__$write(">\n",76);var nbweeks=0,__v_3=month.weeks;void 0==month.weeks&&this.$logError(this.ITERABLE_UNDEFINED,["foreach",78]);for(var week_ct=0,__v_4=__v_3.length,week_index=0;__v_4>week_index;week_index++){var week=__v_3[week_index];week_ct++,nbweeks+=1,this.__$write("\n<tr>\n",80),settings.showWeekNumbers&&(this.__$write('<td class="',81),this.__$write(this.$modifier("escapeforhtml",[skin.baseCSS]),81),this.__$write('weekNumber">',81),0==week.overlappingDays||week.monthEnd==month.monthKey?this.__$write(this.$modifier("escapeforhtml",[week.weekNumber]),81):this.__$write("&nbsp;",81),this.__$write("</td>",81));var __v_5=week.days;void 0==week.days&&this.$logError(this.ITERABLE_UNDEFINED,["foreach",82]);for(var day_ct=0,__v_6=__v_5.length,day_index=0;__v_6>day_index;day_index++){var day=__v_5[day_index];day_ct++,this.macro_renderDay(day,month)}this.__$write("\n</tr>\n",85)}for(;5>=nbweeks;nbweeks++)this.__$write("\n<tr>\n",88),settings.showWeekNumbers&&(this.__$write('<td class="',89),this.__$write(this.$modifier("escapeforhtml",[skin.baseCSS]),89),this.__$write('weekNumber" style="visibility: hidden;">&nbsp;</td>',89)),this.__$write('\n<td class="',90),this.__$write(this.$modifier("escapeforhtml",[skin.baseCSS]),90),this.__$write('day" colspan="7" style="visibility: hidden;">&nbsp;</td>\n</tr>\n',90);this.__$write("\n</tbody>\n</table>\n",93)}}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["renderMonth",this["aria:currentLineNumber"]],_ex)}},macro_renderDay:function(day,month){try{with(this){var jsDate=day.jsDate;day.monthKey==month.monthKey?(this.__$write("\n<td ",100),day.isSelectable&&(this.__$write(' data-date="',100),this.__$write(this.$modifier("escapeforhtml",[jsDate.getTime()]),100),this.__$write('" ',100)),this.__$write('\nclass="',101),this.__$write(this.$modifier("escapeforhtml",[getClassForDay(day)]),101),this.__$write('"\n>',101),this.__$write(this.$modifier("escapeforhtml",[day.label]),102),this.__$write("</td>\n",102)):this.__$write("\n<td />\n",104)}}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["renderDay",this["aria:currentLineNumber"]],_ex)}},$init:function(e){e.__$macrolibs={},e.__$width={},e.__$height={},aria.core.TplClassLoader._importScriptPrototype(aria.widgets.calendar.CalendarTemplateScript,e)},__$initTemplate:function(){try{with(this)this.calendar=data.calendar,this.settings=data.settings,this.skin=data.skin}catch(_ex){return this.$logError(this.EXCEPTION_IN_VARINIT,[this.$classpath],_ex),!1}return!0}}});
//*******************
...
//*******************
Aria.classDefinition({$classpath:"aria.widgets.container.TabStyle",$extends:"aria.widgets.WidgetStyle",$extendsType:"CSS",$constructor:function(){this.$WidgetStyle.constructor.call(this)},$destructor:function(){this.$WidgetStyle.$destructor.call(this)},$prototype:{macro_writeStateOfTableFrame:function(info){try{with(this){this.$WidgetStyle.macro_writeStateOfTableFrame.apply(this,[info]);var prefix=cssPrefix(info),stateName=info.stateName;this.__$write("\n.",12),this.__$write(prefix,12),this.__$write("tlc,\n.",12),this.__$write(prefix,13),this.__$write("ts,\n.",13),this.__$write(prefix,14),this.__$write("trc,\n.",14),this.__$write(prefix,15),this.__$write("ls,\n.",15),this.__$write(prefix,16),this.__$write("m,\n.",16),this.__$write(prefix,17),this.__$write("rs,\n.",17),this.__$write(prefix,18),this.__$write("blc,\n.",18),this.__$write(prefix,19),this.__$write("bs,\n.",19),this.__$write(prefix,20),this.__$write("brc {\n",20),this.macro_writeCursor(stateName),this.__$write("\n}\n",22),/Focused/.test(stateName)&&(this.__$write("\n.",24),this.__$write(prefix,24),this.__$write("c {\noutline: 1px dotted;\n}\n",24))}}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["writeStateOfTableFrame",this["aria:currentLineNumber"]],_ex)}},macro_writeStateOfSimpleFrame:function(info){try{with(this)this.$WidgetStyle.macro_writeStateOfSimpleFrame.apply(this,[info]),this.__$write("\n.",32),this.__$write(cssPrefix(info),32),this.__$write("frame {\n",32),this.macro_writeCursor(info.stateName),this.__$write("\n}\n",34)}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["writeStateOfSimpleFrame",this["aria:currentLineNumber"]],_ex)}},macro_writeStateOfFixedHeightFrame:function(info){try{with(this)this.$WidgetStyle.macro_writeStateOfFixedHeightFrame.apply(this,[info]),this.__$write("\n.",39),this.__$write(cssPrefix(info),39),this.__$write("w {\n",39),this.macro_writeCursor(info.stateName),this.__$write("\n}\n",41)}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["writeStateOfFixedHeightFrame",this["aria:currentLineNumber"]],_ex)}},macro_writeCursor:function(stateName){try{with(this)"disabled"==stateName?this.__$write("\ncursor: default;\n",46):this.__$write("\ncursor: pointer;\n",48)}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["writeCursor",this["aria:currentLineNumber"]],_ex)}},__$initTemplate:function(){if(!this.$WidgetStyle.__$initTemplate.call(this))return!1;try{with(this)this.skinnableClassName="Tab",this.useFrame=!0}catch(_ex){return this.$logError(this.EXCEPTION_IN_VARINIT,[this.$classpath],_ex),!1}return!0}}});
//*******************
...
//*******************
var e=require("../../Aria");require("../Template"),require("./ErrorListController"),require("../../DomEvent");var t=require("../TemplateBasedWidget"),i=require("../../utils/Json");module.exports=e.classDefinition({$classpath:"aria.widgets.errorlist.ErrorList",$extends:t,$onload:function(){e.load({templates:["aria.widgets.errorlist.ErrorListTemplate"]})},$constructor:function(e){this.$TemplateBasedWidget.constructor.apply(this,arguments);var t=aria.widgets.AriaSkinInterface.getSkinObject(this._skinnableClass,this._cfg.sclass),r=i.copy(e,!0,["width","minWidth","maxWidth","height","minHeight","block","maxHeight"]);r.sclass=t.divsclass,r.margins="0 0 0 0",r.id=e.id+"_div",this._initTemplate({defaultTemplate:this._cfg.defaultTemplate,moduleCtrl:{classpath:"aria.widgets.errorlist.ErrorListController",initArgs:{divCfg:r,filterTypes:e.filterTypes,displayCodes:e.displayCodes,title:e.title,messages:e.messages}}})},$destructor:function(){this.$TemplateBasedWidget.$destructor.call(this)},$prototype:{_skinnableClass:"ErrorList",_onBoundPropertyChange:function(e,t){this._inOnBoundPropertyChange=!0;try{if("messages"==e){var i=this._domElt;this._subTplModuleCtrl.setMessages(t,i)}this._cfg[e]=t}finally{this._inOnBoundPropertyChange=!1}}}});
//*******************
//LOGICAL-PATH:aria/widgets/errorlist/ErrorListTemplate.tpl
//*******************
Aria.classDefinition({$classpath:"aria.widgets.errorlist.ErrorListTemplate",$extends:"aria.templates.Template",$constructor:function(){this.$Template.constructor.call(this),this.$ErrorListTemplateScript.constructor.call(this)},$destructor:function(){this.$ErrorListTemplateScript.$destructor.call(this),this.$Template.$destructor.call(this)},$dependencies:["aria.widgets.AriaLib","aria.widgets.errorlist.ErrorListTemplateScript","aria.widgets.container.Div","aria.widgets.Icon","aria.utils.String","aria.widgets.action.Link","aria.core.TplClassLoader"],$prototype:{macro_main:function(){try{with(this)data.messages.length>0&&this.__$beginContainerWidget("aria.widgets.AriaLib","Div",data.divCfg,8)&&(this.__$processWidgetMarkup("aria.widgets.AriaLib","Icon",{icon:getIcon()},9),this.__$write('\n<span style="padding: 3px 16px 3px 10px; font-weight: bold;">',10),this.__$write(this.$modifier("escapeforhtml",[data.title]),10),this.__$write('</span>\n<div style="padding: 3px 0 0 0;">\n',10),this.macro_messagesList(data.messages),this.__$write("\n</div>\n",13),this.__$endContainerWidget())}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["main",this["aria:currentLineNumber"]],_ex)}},macro_messagesList:function(messages,indentation){try{with(this){this.__$write('\n<ul style="margin: 0 0 0 10px; padding-left: 10px;">\n',19);var __v_1=messages;void 0==messages&&this.$logError(this.ITERABLE_UNDEFINED,["foreach",20]);for(var msg_ct=0,__v_2=__v_1.length,msg_index=0;__v_2>msg_index;msg_index++){var msg=__v_1[msg_index];msg_ct++,this.__$write('\n<li style="list-style-type: square;">\n',21),msg.metaDataRef?this.__$processWidgetMarkup("aria.widgets.AriaLib","Link",{label:getDisplayMessage(msg),onclick:{fn:clickOnMessage,args:msg}},23):this.__$write(this.$modifier("escapeforhtml",[getDisplayMessage(msg)]),28),msg.subMessages&&this.macro_messagesList(msg.subMessages),this.__$write("\n</li>\n",33)}this.__$write("\n</ul>\n",35)}}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["messagesList",this["aria:currentLineNumber"]],_ex)}},$init:function(e){e.__$macrolibs={},e.__$width={},e.__$height={},aria.core.TplClassLoader._importScriptPrototype(aria.widgets.errorlist.ErrorListTemplateScript,e)},__$initTemplate:function(){return!0}}});
//*******************
//LOGICAL-PATH:aria/widgets/errorlist/ErrorListTemplateScript.js
//*******************
var e=require("../../Aria"),t=require("../../utils/Data"),i=require("../../utils/Dom");module.exports=e.tplScriptDefinition({$classpath:"aria.widgets.errorlist.ErrorListTemplateScript",$statics:{ICONS:[],DEFAULT_ICON:"std:missing"},$prototype:{$init:function(e){e.ICONS.push({type:t.TYPE_ERROR,icon:"std:error"},{type:t.TYPE_WARNING,icon:"std:warning"},{type:t.TYPE_INFO,icon:"std:info"},{type:t.TYPE_FATAL,icon:"std:error"},{type:t.TYPE_NOTYPE,icon:"std:info"},{type:t.TYPE_CRITICAL_WARNING,icon:"std:warning"},{type:t.TYPE_CONFIRMATION,icon:"std:confirm"})},onModuleEvent:function(e){"messagesChanged"==e.name&&(e.domRef&&i.scrollIntoView(e.domRef),this.$refresh())},clickOnMessage:function(e,t){this.moduleCtrl.focusField(t)},getIcon:function(){for(var e=this.data.messageTypes,t=this.DEFAULT_ICON,i=this.ICONS,r=0,s=i.length;s>r;r++){var a=i[r];if(e[a.type]>0){t=a.icon;break}}return t},getDisplayMessage:function(e){return this.data.displayCodes&&(e.code||0===e.code)?e.localizedMessage+" ("+e.code+")":e.localizedMessage}}});
//*******************
//LOGICAL-PATH:aria/widgets/form/list/templates/LCTemplate.tpl
//*******************
Aria.classDefinition({$classpath:"aria.widgets.form.list.templates.LCTemplate",$extends:"aria.widgets.form.list.templates.ListTemplate",$extendsType:"TPL",$constructor:function(){this.$ListTemplate.constructor.call(this)},$destructor:function(){this.$ListTemplate.$destructor.call(this)},$dependencies:["aria.widgets.AriaLib","aria.utils.String","aria.utils.Type"],$prototype:{macro_renderItem:function(item,itemIdx){try{with(this){var className=_getClassForItem(item),entry=item.object.entry;this.__$write('\n\n<a href="javascript:void(0)" class="',10),this.__$write(this.$modifier("escapeforhtml",[className]),11),this.__$write('" data-itemIdx="',11),this.__$write(this.$modifier("escapeforhtml",[itemIdx]),11),this.__$write('" onclick="return false;">\n',11),item.label?item.value.multiWordMatch?this.__$write(this.$modifier("escapeForHTML",[this.$modifier("highlightfromnewword",[this.$modifier("escapeForHTML",[item.label,{text:!0}]),entry]),!1]),15):this.__$write(this.$modifier("escapeForHTML",[this.$modifier("starthighlight",[this.$modifier("escapeForHTML",[item.label,{text:!0}]),entry]),!1]),17):this.__$write("\n&nbsp;\n",13),this.__$write("\n</a>\n",19)}}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["renderItem",this["aria:currentLineNumber"]],_ex)}},__$initTemplate:function(){return this.$ListTemplate.__$initTemplate.call(this)?!0:!1}}});
//*******************
//LOGICAL-PATH:aria/widgets/form/list/templates/ListTemplate.tpl
//*******************
Aria.classDefinition({$classpath:"aria.widgets.form.list.templates.ListTemplate",$extends:"aria.templates.Template",$constructor:function(){this.$Template.constructor.call(this),this.$ListTemplateScript.constructor.call(this)},$destructor:function(){this.$ListTemplateScript.$destructor.call(this),this.$Template.$destructor.call(this)},$dependencies:["aria.widgets.AriaLib","aria.widgets.form.list.templates.ListTemplateScript","aria.widgets.container.Div","aria.utils.String","aria.core.TplClassLoader"],$prototype:{macro_main:function(){try{with(this)this.__$beginContainerWidget("aria.widgets.AriaLib","Div",data.cfg,8)&&(this.__$insertSection(9,{id:"Items",macro:"renderList"}),this.__$endContainerWidget())}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["main",this["aria:currentLineNumber"]],_ex)}},macro_renderList:function(){try{with(this){this.__$write("\n<div ",14),this.__$writeId("myList",14),data.disabled||(this.__$statementOnEvent("mouseup",this.$normCallback({fn:"itemClick"}),16),this.__$statementOnEvent("mouseover",this.$normCallback({fn:"itemMouseOver"}),17)),this.__$write('\n>\n<a href="#" style="display: none;">&nbsp;</a>\n',19);var __v_1=data.items;void 0==data.items&&this.$logError(this.ITERABLE_UNDEFINED,["foreach",21]);for(var item_ct=0,__v_2=__v_1.length,item_index=0;__v_2>item_index;item_index++){var item=__v_1[item_index];item_ct++,this.macro_renderItem(item,item_index)}this.__$write("\n</div>\n",24)}}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["renderList",this["aria:currentLineNumber"]],_ex)}},macro_renderItem:function(item,itemIdx){try{with(this){var a=_getClassForItem(item);this.__$write('\n<a href="javascript:void(0)" class="',29),this.__$write(this.$modifier("escapeforhtml",[a]),29),this.__$write('" data-itemIdx="',29),this.__$write(this.$modifier("escapeforhtml",[itemIdx]),29),this.__$write('" onclick="return false;">\n',29),item.label?this.__$write(this.$modifier("escapeForHTML",[item.label,{text:!0}]),33):this.__$write("\n&nbsp;\n",31),this.__$write("\n</a>\n",35)}}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["renderItem",this["aria:currentLineNumber"]],_ex)}},$init:function(e){e.__$macrolibs={},e.__$width={},e.__$height={},aria.core.TplClassLoader._importScriptPrototype(aria.widgets.form.list.templates.ListTemplateScript,e)},__$initTemplate:function(){return!0}}});
//*******************
...
//*******************
Aria.classDefinition({$classpath:"aria.widgets.form.list.ListStyle",$extends:"aria.widgets.WidgetStyle",$extendsType:"CSS",$constructor:function(){this.$WidgetStyle.constructor.call(this)},$destructor:function(){this.$WidgetStyle.$destructor.call(this)},$prototype:{macro_writeSkinClass:function(info){try{with(this){var skinClassName=info.skinClassName,skinClass=info.skinClass;this.__$write("\n\n\na.x",10),this.__$write(skinnableClassName,12),this.__$write("Item_",12),this.__$write(skinClassName,12),this.__$write(",\na.x",12),this.__$write(skinnableClassName,13),this.__$write("Item_",13),this.__$write(skinClassName,13),this.__$write(":link,\na.x",13),this.__$write(skinnableClassName,14),this.__$write("Item_",14),this.__$write(skinClassName,14),this.__$write(":active,\na.x",14),this.__$write(skinnableClassName,15),this.__$write("TItem_",15),this.__$write(skinClassName,15),this.__$write(":visited {\ncolor: #000;\ntext-decoration:none;\n}\n\na.x",15),this.__$write(skinnableClassName,20),this.__$write("Item_",20),this.__$write(skinClassName,20),this.__$write(" {\ndisplay: block;\npadding:1px 1px 1px 2px;\nmargin: 1px ",20),this.__$write(skinClass.link.marginRight,23),this.__$write("px 1px ",23),this.__$write(skinClass.link.marginLeft,23),this.__$write("px;\n}\n\n\n.x",23),this.__$write(skinnableClassName,27),this.__$write("EnabledItem_",27),this.__$write(skinClassName,27),this.__$write(" {\ncolor:",27),this.__$write(skinClass.enabledColor,28),this.__$write(";\ncursor:pointer;\n}\n\n.x",28),this.__$write(skinnableClassName,32),this.__$write("MouseOverItem_",32),this.__$write(skinClassName,32),this.__$write(" {\nbackground-color:",32),this.__$write(skinClass.mouseOverBackgroundColor,33),this.__$write(";\ncolor:",33),this.__$write(skinClass.mouseOverColor,34),this.__$write(";\n}\n\n.x",34),this.__$write(skinnableClassName,37),this.__$write("EnabledItem_",37),this.__$write(skinClassName,37),this.__$write(":hover,\na.x",37),this.__$write(skinnableClassName,38),this.__$write("EnabledItem_",38),this.__$write(skinClassName,38),this.__$write(":hover {\n",38),skinClass.highlightMouseOver&&(this.__$write("\nbackground-color:",40),this.__$write(skinClass.mouseOverBackgroundColor,40),this.__$write(";\ncolor: ",40),this.__$write(skinClass.mouseOverColor,41),this.__$write(";\n",41)),this.__$write("\ntext-decoration: none;\n}\n\n.x",43),this.__$write(skinnableClassName,46),this.__$write("SelectedItem_",46),this.__$write(skinClassName,46),this.__$write(",\n.x",46),this.__$write(skinnableClassName,47),this.__$write("SelectedItem_",47),this.__$write(skinClassName,47),this.__$write(":link,\n.x",47),this.__$write(skinnableClassName,48),this.__$write("SelectedItem_",48),this.__$write(skinClassName,48),this.__$write(":visited,\n.x",48),this.__$write(skinnableClassName,49),this.__$write("SelectedItem_",49),this.__$write(skinClassName,49),this.__$write(":active,\na.x",49),this.__$write(skinnableClassName,50),this.__$write("SelectedItem_",50),this.__$write(skinClassName,50),this.__$write(",\na.x",50),this.__$write(skinnableClassName,51),this.__$write("SelectedItem_",51),this.__$write(skinClassName,51),this.__$write(":link,\na.x",51),this.__$write(skinnableClassName,52),this.__$write("SelectedItem_",52),this.__$write(skinClassName,52),this.__$write(":visited,\na.x",52),this.__$write(skinnableClassName,53),this.__$write("SelectedItem_",53),this.__$write(skinClassName,53),this.__$write(":active  {\nbackground-color: ",53),this.__$write(skinClass.selectedItemBackgroundColor,54),this.__$write(";\ncolor: ",54),this.__$write(skinClass.selectedItemColor,55),this.__$write(";\n}\n\n.x",55),this.__$write(skinnableClassName,58),this.__$write("DisabledItem_",58),this.__$write(skinClassName,58),this.__$write(",\na.x",58),this.__$write(skinnableClassName,59),this.__$write("DisabledItem_",59),this.__$write(skinClassName,59),this.__$write(":visited,\na.x",59),this.__$write(skinnableClassName,60),this.__$write("DisabledItem_",60),this.__$write(skinClassName,60),this.__$write(":hover,\na.x",60),this.__$write(skinnableClassName,61),this.__$write("DisabledItem_",61),this.__$write(skinClassName,61),this.__$write(":link {\ncolor:#888;\ncursor:default;\n}\n\n.x",61),this.__$write(skinnableClassName,66),this.__$write("Footer_",66),this.__$write(skinClassName,66),this.__$write(" {\npadding:",66),this.__$write(skinClass.footer.padding,67),this.__$write("px;\nbackground-color: ",67),this.__$write(skinClass.footer.backgroundColor,68),this.__$write(";\nborder-color: ",68),this.__$write(skinClass.footer.borderColor,69),this.__$write(";\n",69),skinClass.footer.borderTopOnly?this.__$write("border-top-style",70):this.__$write("border-style",70),this.__$write(": ",70),this.__$write(skinClass.footer.borderStyle,70),this.__$write(";\nborder-width: ",70),this.__$write(skinClass.footer.borderWidth,71),this.__$write("px;\nmargin:    ",71),this.__$write(skinClass.footer.marginTop,72),this.__$write("px ",72),this.__$write(skinClass.footer.marginRight,72),this.__$write("px ",72),this.__$write(skinClass.footer.marginBottom,72),this.__$write("px ",72),this.__$write(skinClass.footer.marginLeft,72),this.__$write("px;\n}\n",72)}}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["writeSkinClass",this["aria:currentLineNumber"]],_ex)}},__$initTemplate:function(){if(!this.$WidgetStyle.__$initTemplate.call(this))return!1;try{with(this)this.skinnableClassName="List"}catch(_ex){return this.$logError(this.EXCEPTION_IN_VARINIT,[this.$classpath],_ex),!1}return!0}}});
//*******************
...
//*******************
var e=require("../Aria"),t=require("../widgetLibs/WidgetLib");module.exports=e.classDefinition({$classpath:"aria.widgets.AriaLib",$singleton:!0,$extends:t,$prototype:{widgets:{Fieldset:"aria.widgets.container.Fieldset",Button:"aria.widgets.action.Button",IconButton:"aria.widgets.action.IconButton",Tooltip:"aria.widgets.container.Tooltip",Text:"aria.widgets.Text",Calendar:"aria.widgets.calendar.Calendar",Dialog:"aria.widgets.container.Dialog",Link:"aria.widgets.action.Link",Div:"aria.widgets.container.Div",TextField:"aria.widgets.form.TextField",Textarea:"aria.widgets.form.Textarea",Splitter:"aria.widgets.container.Splitter",Tab:"aria.widgets.container.Tab",TabPanel:"aria.widgets.container.TabPanel",PasswordField:"aria.widgets.form.PasswordField",DateField:"aria.widgets.form.DateField",DatePicker:"aria.widgets.form.DatePicker",MultiSelect:"aria.widgets.form.MultiSelect",TimeField:"aria.widgets.form.TimeField",NumberField:"aria.widgets.form.NumberField",AutoComplete:"aria.widgets.form.AutoComplete",CheckBox:"aria.widgets.form.CheckBox",RadioButton:"aria.widgets.form.RadioButton",Icon:"aria.widgets.Icon",SelectBox:"aria.widgets.form.SelectBox",Select:"aria.widgets.form.Select",SortIndicator:"aria.widgets.action.SortIndicator",Template:"aria.widgets.Template",List:"aria.widgets.form.list.List",Gauge:"aria.widgets.form.Gauge",ErrorList:"aria.widgets.errorlist.ErrorList",MultiAutoComplete:"aria.widgets.form.MultiAutoComplete"}}});
//*******************
//LOGICAL-PATH:aria/widgets/Text.js
//*******************
var e=require("../Aria"),t=require("../utils/Ellipsis");require("../DomEvent");var i=require("../utils/Dom"),r=require("../utils/String"),s=require("./Widget"),a=require("../utils/Type");module.exports=e.classDefinition({$classpath:"aria.widgets.Text",$extends:s,$constructor:function(e){this.$Widget.constructor.apply(this,arguments),a.isString(e.ellipsis)&&(this._activateEllipsis=!0,this._directInit=!0),this._defaultMargin=0},$destructor:function(){this.textContent=null,this._ellipsis&&(this._ellipsis.$dispose(),this._ellipsis=null),this._hasMouseOver=null,this._hasFocus=null,this.$Widget.$destructor.call(this)},$prototype:{_activateEllipsis:!1,_hasMouseOver:!1,_hasFocus:!1,_widgetMarkup:function(e){var t=this._cfg.text;t=null!==t?""+t:"",this.textContent=t,e.write('<span class="createdEllipisElement">'+r.escapeHTML(this.textContent)+"</span>")},_init:function(){this._activateEllipsis===!0&&this.__ellipseText(this._cfg.text)},__ellipseText:function(e){e=null!==e?""+e:"";var s=this.getDom();if(s){var a=r;this.textContent=e,s.style.display="inline-block",s.style.overflow="hidden",s.style.whiteSpace="nowrap",s.style.verticalAlign="top";var n,o=i.getDomElementChild(s,0);o||(s.innerHTML='<span class="createdEllipisElement">'+a.escapeHTML(this.textContent)+"</span>",o=i.getDomElementChild(s,0)),this._cfg.width>0&&(n=this._cfg.width,s.style.width=this._cfg.width+"px",this._ellipsis=new t(o,n,this._cfg.ellipsisLocation,this._cfg.ellipsis,this._context,this._cfg.ellipsisEndStyle),this._ellipsis.ellipsesNeeded||(s.removeChild(o),s.innerHTML=a.escapeHTML(e)))}},_onBoundPropertyChange:function(e,t){var i=this.getDom();"text"==e&&null!==t&&(this._activateEllipsis?(i.innerHTML="",this.__ellipseText(t)):(t=""+t,i.getElementsByTagName("span")[0].innerHTML=r.escapeHTML(t),this.textContent=t))},_dom_onmouseover:function(e){this.$Widget._dom_onmouseover.call(this,e),this._ellipsis&&this._ellipsis.ellipsesNeeded&&(this._hasMouseOver=!0,this._ellipsis.displayFullText({left:0,top:0}))},_dom_onmouseout:function(e){this.$Widget._dom_onmouseout.call(this,e),this._ellipsis&&this._ellipsis.ellipsesNeeded&&this._hasFocus===!1&&this._hasMouseOver===!0&&(this._hasMouseOver=!1,this._ellipsis._hideFullText(e.relatedTarget))}}});
//*******************
//LOGICAL-PATH:aria/widgets/TextStyle.cml
//*******************
Aria.classDefinition({$classpath:"aria.widgets.TextStyle",$extends:"aria.templates.CSSTemplate",$constructor:function(){this.$CSSTemplate.constructor.call(this)},$destructor:function(){this.$CSSTemplate.$destructor.call(this)},$prototype:{macro_writeFontStyleInner:function(font){try{with(this)font.size&&(this.__$write("\nfont-size: ",7),this.__$write(font.size,7),this.__$write("px;\n",7)),font.family&&(this.__$write("\nfont-family: ",10),this.__$write(font.family,10),this.__$write(";\n",10))}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["writeFontStyleInner",this["aria:currentLineNumber"]],_ex)}},macro_writeAnchorsStyle:function(states,prefix){try{with(this)prefix=prefix||"",this.__$write(prefix,16),this.__$write(" a {\n",16),this.macro_writeAnchorState(states.normal),this.__$write("\n}\n",18),this.__$write(prefix,19),this.__$write(" a:link {\n",19),this.macro_writeAnchorState(states.link),this.__$write("\n}\n",21),this.__$write(prefix,22),this.__$write(" a:visited {\n",22),this.macro_writeAnchorState(states.visited),this.__$write("\n}\n",24),this.__$write(prefix,25),this.__$write(" a:hover {\n",25),this.macro_writeAnchorState(states.hover),this.__$write("\n}\n",27),this.__$write(prefix,28),this.__$write(" a:focus {\n",28),this.macro_writeAnchorState(states.focus),this.__$write("\n}\n",30)}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["writeAnchorsStyle",this["aria:currentLineNumber"]],_ex)}},macro_writeAnchorState:function(state){try{with(this)state&&(state.color&&(this.__$write("\ncolor: ",36),this.__$write(state.color,36),this.__$write(";\n",36)),state.text.decoration&&(this.__$write("\ntext-decoration: ",39),this.__$write(state.text.decoration,39),this.__$write(";\n",39)),state.outline&&(this.__$write("\noutline: ",42),this.__$write(state.outline,42),this.__$write(";\n",42)))}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["writeAnchorState",this["aria:currentLineNumber"]],_ex)}},$init:function(e){e.__$csslibs={},e.__$prefix=!0},__$initTemplate:function(){return!0}}});
//*******************
//LOGICAL-PATH:aria/widgets/WidgetStyle.tpl.css
//*******************
Aria.classDefinition({$classpath:"aria.widgets.WidgetStyle",$extends:"aria.templates.CSSTemplate",$constructor:function(){this.$CSSTemplate.constructor.call(this),this.$WidgetStyleScript.constructor.call(this)},$destructor:function(){this.$WidgetStyleScript.$destructor.call(this),this.$CSSTemplate.$destructor.call(this)},$dependencies:["aria.utils.Type","aria.widgets.AriaSkinInterface","aria.widgets.WidgetStyleScript","aria.core.TplClassLoader"],$prototype:{macro_main:function(){try{with(this)this.macro_startLooping()}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["main",this["aria:currentLineNumber"]],_ex)}},macro_startLooping:function(){try{with(this){var skinClasses=aria.widgets.AriaSkinInterface.getSkinClasses(skinnableClassName),__v_1=skinClasses;void 0==skinClasses&&this.$logError(this.ITERABLE_UNDEFINED,["foreach",16]);var skinClass_ct=0;for(var skinClass_index in __v_1)if(__v_1.hasOwnProperty(skinClass_index)&&!this.$json.isMetadata(skinClass_index)){var skinClass=__v_1[skinClass_index];skinClass_ct++;var info={skinClassName:skinClass_index,skinClass:skinClass};this.macro_writeSkinClass(info),this.macro_writeAllStates(info)}}}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["startLooping",this["aria:currentLineNumber"]],_ex)}},macro_writeAllStates:function(info){try{with(this){var states=aria.widgets.AriaSkinInterface.getWidgetStates(skinnableClassName);if(states){var __v_2=states;void 0==states&&this.$logError(this.ITERABLE_UNDEFINED,["foreach",29]);var state_ct=0;for(var state_index in __v_2)if(__v_2.hasOwnProperty(state_index)&&!this.$json.isMetadata(state_index)){{__v_2[state_index]}state_ct++;var info={skinClassName:info.skinClassName,skinClass:info.skinClass,stateName:state_index,state:info.skinClass.states[state_index]};useFrame&&this.macro_writeStateOfFrame(info),this.macro_writeState(info)}}}}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["writeAllStates",this["aria:currentLineNumber"]],_ex)}},macro_writeSkinClass:function(info){try{with(this);}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["writeSkinClass",this["aria:currentLineNumber"]],_ex)}},macro_writeState:function(info){try{with(this);}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["writeState",this["aria:currentLineNumber"]],_ex)}},macro_background:function(color,imageurl,otherparams){try{with(this)void 0===color&&(color=""),void 0===imageurl&&(imageurl=""),void 0===otherparams&&(otherparams=""),this.__$write(aria.widgets.AriaSkinInterface.backgroundMacro(color,imageurl,otherparams),56)}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["background",this["aria:currentLineNumber"]],_ex)}},macro_opacity:function(percent){try{with(this)this.__$write("\nfilter: alpha(opacity=",60),this.__$write(percent,60),this.__$write(");\n-moz-opacity: ",60),this.__$write(percent/100,61),this.__$write(";\nopacity: ",61),this.__$write(percent/100,62),this.__$write(";\n",62)}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["opacity",this["aria:currentLineNumber"]],_ex)}},macro_writeStateOfFixedHeightFrame:function(info){try{with(this){var state=info.state.frame,sprWidth=state.sprWidth,sprHeight=state.sprHeight,sprIndex=state.sprIdx,sprSpacing=state.sprSpacing,refTop=(sprHeight+sprSpacing)*sprIndex,spcLeft=state.spcLeft,spcRight=sprWidth-spcLeft,prefix=cssPrefix(info),verticalAlignApplied=state.verticalAlign&&state.innerHeight;this.__$write("\n.",78),this.__$write(prefix,78),this.__$write("bkgA {\n",78),this.macro_background("transparent",state.spriteURL,"no-repeat scroll 0 0"),this.__$write("\nfont-size:1px;\n}\n.",80),this.__$write(prefix,82),this.__$write("bkgB {\n",82),this.macro_background("transparent",state.spriteURLv,"repeat-x 0 0"),this.__$write("\n}\n.",84),this.__$write(prefix,85),this.__$write("w {\nheight:",85),this.__$write(sprHeight,86),this.__$write("px;\n}\n.",86),this.__$write(prefix,88),this.__$write("c {\nmargin: ",88),this.__$write(state.marginTop,89),this.__$write("px ",89),this.__$write(state.marginRight,89),this.__$write("px ",89),this.__$write(state.marginBottom,89),this.__$write("px ",89),this.__$write(state.marginLeft,89),this.__$write("px;\ncolor: ",89),this.__$write(state.color,90),this.__$write(";\n",90),verticalAlignApplied&&(this.__$write("\nvertical-align: ",92),this.__$write(state.verticalAlign,92),this.__$write(";\nline-height: ",92),this.__$write(state.innerHeight+(aria.utils.Type.isNumber(state.innerHeight)?"px":""),93),this.__$write(";\n",93)),this.__$write("\n}\n",95),1!=state.skipLeftBorder&&(this.__$write("\n.",97),this.__$write(prefix,97),this.__$write("b {width:",97),this.__$write(spcLeft,97),this.__$write("px; height:",97),this.__$write(sprHeight,97),this.__$write("px; background-position:0 ",97),this.__$write(-refTop,97),this.__$write("px;\n",97),verticalAlignApplied&&(this.__$write("\nline-height:",99),this.__$write(sprHeight,99),this.__$write("px;\n",99)),this.__$write("\n}\n",101)),this.__$write("\n.",103),this.__$write(prefix,103),this.__$write("m {height:",103),this.__$write(sprHeight,103),this.__$write("px; background-position:0 ",103),this.__$write(-refTop,103),this.__$write("px;\n",103),verticalAlignApplied&&(this.__$write("\nline-height:",105),this.__$write(sprHeight,105),this.__$write("px;\n",105)),this.__$write("\n}\n",107),1!=state.skipRightBorder&&(this.__$write("\n.",109),this.__$write(prefix,109),this.__$write("e {width:",109),this.__$write(spcRight,109),this.__$write("px; height:",109),this.__$write(sprHeight,109),this.__$write("px; background-position: ",109),this.__$write(-spcLeft,109),this.__$write("px ",109),this.__$write(-refTop,109),this.__$write("px;\n",109),verticalAlignApplied&&(this.__$write("\nline-height:",111),this.__$write(sprHeight,111),this.__$write("px;\n",111)),this.__$write("\n}\n",113))}}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["writeStateOfFixedHeightFrame",this["aria:currentLineNumber"]],_ex)}},macro_writeStateOfSimpleFrame:function(info){try{with(this){var state=info.state.frame,padTop=state.paddingTop;this.__$write("\n.",120),this.__$write(cssPrefix(info),120),this.__$write("frame  {\n",120),state.frameHeight&&(this.__$write("\nheight: ",122),this.__$write(state.frameHeight,122),this.__$write("px;\n",122)),this.__$write("\nborder-top: ",124),this.__$write(null!=state.borderTop?state.borderTop:state.borderSize,124),this.__$write("px ",124),this.__$write(state.border,124),this.__$write(" ",124),this.__$write(state.borderColor,124),this.__$write(";\nborder-bottom: ",124),this.__$write(null!=state.borderBottom?state.borderBottom:state.borderSize,125),this.__$write("px ",125),this.__$write(state.border,125),this.__$write(" ",125),this.__$write(state.borderColor,125),this.__$write(";\nborder-left: ",125),this.__$write(null!=state.borderLeft?state.borderLeft:state.borderSize,126),this.__$write("px ",126),this.__$write(state.border,126),this.__$write(" ",126),this.__$write(state.borderColor,126),this.__$write(";\nborder-right: ",126),this.__$write(null!=state.borderRight?state.borderRight:state.borderSize,127),this.__$write("px ",127),this.__$write(state.border,127),this.__$write(" ",127),this.__$write(state.borderColor,127),this.__$write(";\nmargin-top: ",127),this.__$write(state.marginTop,128),this.__$write("px;\nmargin-bottom: ",128),this.__$write(state.marginBottom,129),this.__$write("px;\nmargin-left: ",129),this.__$write(state.marginLeft,130),this.__$write("px;\nmargin-right: ",130),this.__$write(state.marginRight,131),this.__$write("px;\n",131),state.fontWeight&&(this.__$write("\nfont-weight: ",133),this.__$write(state.fontWeight,133),this.__$write(";\n",133)),this.macro_writeBorderRadius(state),state.boxShadow&&(this.__$write("\nbox-shadow: ",139),this.__$write(state.boxShadow,139),this.__$write(";\n",139)),this.__$write("\npadding: ",141),this.__$write(state.paddingTop,141),this.__$write("px ",141),this.__$write(state.paddingRight,141),this.__$write("px ",141),this.__$write(state.paddingBottom,141),this.__$write("px ",141),this.__$write(state.paddingLeft,141),this.__$write("px;\n",141),padTop>1&&(this.__$write("\n*padding-top: ",143),this.__$write(padTop-1,143),this.__$write("px;\n",143)),this.__$write("\nbackground-color: ",145),this.__$write(state.backgroundColor,145),this.__$write(";\ncolor: ",145),this.__$write(state.color,146),this.__$write(";\nvertical-align: top;\n}\n",146)}}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["writeStateOfSimpleFrame",this["aria:currentLineNumber"]],_ex)}},macro_writeBorderRadius:function(state){try{with(this)this.__$write("\nborder-top-right-radius: ",152),this.__$write(state.borderTopRightRadius,152),this.__$write("px;\nborder-top-left-radius: ",152),this.__$write(state.borderTopLeftRadius,153),this.__$write("px;\nborder-bottom-right-radius: ",153),this.__$write(state.borderBottomRightRadius,154),this.__$write("px;\nborder-bottom-left-radius: ",154),this.__$write(state.borderBottomLeftRadius,155),this.__$write("px;\n",155)}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["writeBorderRadius",this["aria:currentLineNumber"]],_ex)}},macro_writeStateOfTableFrame:function(info){try{with(this){var state=info.state.frame,sprWidth=state.sprWidth,sprHeight=state.sprHeight,sprIndex=state.sprIdx,sprSpacing=state.sprSpacing,refTop=(sprHeight+sprSpacing)*sprIndex,refLeft=(sprWidth+sprSpacing)*sprIndex,spcLeft=state.spcLeft,spcTop=state.spcTop,spcRight=sprWidth-spcLeft,spcBottom=sprHeight-spcTop,prefix=cssPrefix(info);this.__$write("\n\n.",171),this.__$write(prefix,172),this.__$write("bkgA {\n",172),this.macro_background("transparent",state.spriteURL,"no-repeat scroll 0 0"),this.__$write("\nfont-size:1px;\n}\n.",174),this.__$write(prefix,176),this.__$write("bkgB {\n",176),this.macro_background("transparent",state.spriteURLv,"repeat-x 0 0"),this.__$write("\nfont-size:1px;\n}\n.",178),this.__$write(prefix,180),this.__$write("bkgC {\n",180),this.macro_background("transparent",state.spriteURLh,"repeat-y 0 0"),this.__$write("\nfont-size:1px;\n}\n.",182),this.__$write(prefix,184),this.__$write("c {\nmargin: ",184),this.__$write(state.marginTop,185),this.__$write("px ",185),this.__$write(state.marginRight,185),this.__$write("px ",185),this.__$write(state.marginBottom,185),this.__$write("px ",185),this.__$write(state.marginLeft,185),this.__$write("px;\ncolor: ",185),this.__$write(state.color,186),this.__$write(";\n}\n.",186),this.__$write(prefix,188),this.__$write("m {\nbackground-color: ",188),this.__$write(state.backgroundColor,189),this.__$write(";\n}\n.",189),this.__$write(prefix,191),this.__$write("tlc {width:",191),this.__$write(spcLeft,191),this.__$write("px; height:",191),this.__$write(spcTop,191),this.__$write("px; background-position:0 ",191),this.__$write(-refTop,191),this.__$write("px;}\n.",191),this.__$write(prefix,192),this.__$write("ts {height:",192),this.__$write(spcTop,192),this.__$write("px; background-position:0 ",192),this.__$write(-refTop,192),this.__$write("px; }\n.",192),this.__$write(prefix,193),this.__$write("trc {width:",193),this.__$write(spcRight,193),this.__$write("px; height:",193),this.__$write(spcTop,193),this.__$write("px; background-position: ",193),this.__$write(-spcLeft,193),this.__$write("px ",193),this.__$write(-refTop,193),this.__$write("px;}\n.",193),this.__$write(prefix,194),this.__$write("rs {width:",194),this.__$write(spcRight,194),this.__$write("px; background-position:",194),this.__$write(-refLeft-spcLeft,194),this.__$write("px 0;}\n.",194),this.__$write(prefix,195),this.__$write("brc {width:",195),this.__$write(spcRight,195),this.__$write("px; height:",195),this.__$write(spcBottom,195),this.__$write("px; background-position: ",195),this.__$write(-spcLeft,195),this.__$write("px ",195),this.__$write(-refTop-spcTop,195),this.__$write("px;}\n.",195),this.__$write(prefix,196),this.__$write("bs {height: ",196),this.__$write(spcBottom,196),this.__$write("px; background-position:0 ",196),this.__$write(-refTop-spcTop,196),this.__$write("px;}\n.",196),this.__$write(prefix,197),this.__$write("blc {width:",197),this.__$write(spcLeft,197),this.__$write("px; height:",197),this.__$write(spcBottom,197),this.__$write("px; background-position: 0 ",197),this.__$write(-refTop-spcTop,197),this.__$write("px;}\n.",197),this.__$write(prefix,198),this.__$write("ls {width: ",198),this.__$write(spcLeft,198),this.__$write("px; background-position:",198),this.__$write(-refLeft,198),this.__$write("px 0;}\n.",198),this.__$write(prefix,199),this.__$write("frameIcon {\ndisplay: block;\nheight:",199),this.__$write(state.frameHeight,201),this.__$write("px;\n",201),this.macro_background("",state.frameIcon,"no-repeat "+state.frameIconHPos),this.__$write("\n}\n",203)}}catch(_ex){this.$logError(this.EXCEPTION_IN_MACRO,["writeStateOfTableFrame",this["aria:currentLineNumber"]],_ex)}},$init:function(e){e.__$csslibs={},e.__$prefix=!0,aria.core.TplClassLoader._importScriptPrototype(aria.widgets.WidgetStyleScript,e)},__$initTemplate:function(){try{with(this)this.skinnableClassName="Widget",this.useFrame=!1}catch(_ex){return this.$logError(this.EXCEPTION_IN_VARINIT,[this.$classpath],_ex),!1}return!0}}});
//*******************
