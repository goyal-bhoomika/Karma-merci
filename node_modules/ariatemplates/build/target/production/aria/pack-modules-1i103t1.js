...
//*******************
var e=require("../Aria"),t=require("../core/JsonTypes"),i=require("./requestHandler/environment/RequestHandlerCfgBeans");module.exports=e.beanDefinitions({$package:"aria.modules.RequestBeans",$namespaces:{json:t,env:i},$beans:{RequestObject:{$type:"json:Object",$restricted:!1,$properties:{moduleName:{$type:"json:String",$mandatory:!0},actionName:{$type:"json:String",$mandatory:!1},serviceSpec:{$type:"json:ObjectRef",$mandatory:!1},session:{$type:"json:ObjectRef"},actionQueuing:{$type:"json:ObjectRef"},requestHandler:{$type:"json:ObjectRef"},urlService:{$type:"json:ObjectRef"},requestJsonSerializer:{$type:"env:RequestJsonSerializerCfg"},async:{$type:"json:Boolean",$default:!0},timeout:{$type:"json:Integer"},headers:{$type:"json:Map",$contentType:{$type:"json:String"},$sample:{"Content-Type":"text/plain",Connection:"keep-alive"}}}},RequestDetails:{$type:"json:Object",$restricted:!1,$properties:{url:{$type:"json:String",$mandatory:!0},method:{$type:"json:String"}}},SuccessResponse:{$type:"json:Object",$properties:{responseText:{$type:"json:String"},responseXML:{$type:"json:ObjectRef"},responseJSON:{$type:"json:ObjectRef"}}},FailureResponse:{$type:"json:Object",$properties:{status:{$type:"json:Integer",$mandatory:!0},error:{$type:"json:String"},responseText:{$type:"json:String"},responseXML:{$type:"json:ObjectRef"},responseJSON:{$type:"json:ObjectRef"}}},Request:{$type:"json:Object",$properties:{url:{$type:"json:String"},session:{$type:"json:ObjectRef"},requestObject:{$type:"RequestObject"}}},ProcessedResponse:{$type:"json:Object",$restricted:!1,$properties:{response:{$type:"json:ObjectRef"},error:{$type:"json:Boolean"},errorData:{$type:"json:ObjectRef"}}}}});
//*******************
